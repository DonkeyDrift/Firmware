...
<div id="driftCard" class="stateCard"><a href="/drift" style="position:absolute;right:28px;top:8px;font-size:11px;color:#5cc8ff;text-decoration:none;z-index:2">Tune</a><div class="stateHead" data-i18n="state.drift">Drift</div><div class="stateValue" id="driftValue">--</div><div class="stateSub" id="driftSub">waiting</div><div class="driftBar"><i id="driftNeedle"></i></div><span class="stateDot"></span></div>
