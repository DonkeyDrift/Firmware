...
async function openWifiStaModal(){closeWifiScanPopover();staNotice.textContent='注意只能连接2.4G WiFi';document.getElementById('hostWifiToggle').checked=false;onHostWifiToggle();await refreshWifiSta(true);wifiStaModal.classList.add('show')}
