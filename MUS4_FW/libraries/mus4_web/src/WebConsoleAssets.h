...
html:root .stateHead,html:root .version,html:root .helpSection h3,html:root .stateMeta b,html:root .toggleLabel,html:root .settingsView .setRow h3{text-transform:none;letter-spacing:0;font-weight:600;font-size:13px;line-height:1.35}
html:root .stateValue{font-weight:600;letter-spacing:-.02em;line-height:1.15}
html:root .stateSub,html:root .stateMeta,html:root .stateHead{line-height:1.35}
...
html:root .stateCard{border-color:var(--cardLine);transition:background-color .2s var(--ease-apple),border-color .2s var(--ease-apple),box-shadow .2s var(--ease-apple)}
