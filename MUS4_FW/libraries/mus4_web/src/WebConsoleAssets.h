...
/* 座舱象限冻结：本轮新增的断连「重试」入口只在 apple 象限渲染（座舱里原本没有这个元素） */
html:not([data-ui="apple"]) .reconnectActions{display:none}
</style>
<style id="apple-deep">
/* ===== Apple 深化 v1.9.3 — 全部限定 html[data-ui="apple"]；座舱象限逐值不变 ===== */
html[data-ui="apple"]{--ease-apple:cubic-bezier(.32,.72,0,1);--ok-text:#30d158;--warn-text:#ff9f0a;--bad-text:#ff453a;--drift-text:#bf5af2;--sep:rgba(255,255,255,.16);--cardLine:rgba(255,255,255,.10);--mat:rgba(28,28,30,.72);--matSolid:rgba(28,28,30,.96);--elev:0 8px 30px rgba(0,0,0,.5);--appleFont:-apple-system,BlinkMacSystemFont,system-ui,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;--appleMono:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;--ink2:rgba(235,235,245,.85);--ink3:rgba(235,235,245,.72);--inkPill:rgba(235,235,245,.72);--inkT:rgba(235,235,245,.72);--segInk:rgba(235,235,245,.72);--cardShadow:0 1px 3px rgba(0,0,0,.55)}
html[data-ui="apple"][data-theme="light"]{--ok-text:#1a7f37;--warn-text:#c93400;--bad-text:#d70015;--drift-text:#8944ab;--sep:rgba(60,60,67,.29);--cardLine:rgba(0,0,0,.08);--mat:rgba(245,245,247,.72);--matSolid:rgba(245,245,247,.96);--elev:0 8px 30px rgba(0,0,0,.12);--ink2:rgba(60,60,67,.85);--ink3:rgba(60,60,67,.72);--ink4:rgba(60,60,67,.62);--inkPill:rgba(60,60,67,.72);--inkT:rgba(60,60,67,.72);--segInk:rgba(60,60,67,.85);--cardShadow:0 1px 3px rgba(0,0,0,.06);--logInk:#1a7f37}
html[data-ui="apple"],html[data-ui="apple"] *{-webkit-tap-highlight-color:transparent}
html[data-ui="apple"] body{font-family:var(--appleFont);-webkit-font-smoothing:antialiased;padding-bottom:env(safe-area-inset-bottom)}
html[data-ui="apple"] button,html[data-ui="apple"] input,html[data-ui="apple"] select,html[data-ui="apple"] textarea{font-family:inherit}
html[data-ui="apple"] .headerRow,html[data-ui="apple"] .langButton{font-family:var(--appleFont)}
html[data-ui="apple"] .log,html[data-ui="apple"] .statusRow span,html[data-ui="apple"] .rcCell span,html[data-ui="apple"] .rcNum,html[data-ui="apple"] .legend b,html[data-ui="apple"] .recMeta b,html[data-ui="apple"] .termTab{font-family:var(--appleMono)}
/* 聚焦环：不透明 accent 3px，覆盖 UA 默认与 .rcNum:focus{outline:none} */
html[data-ui="apple"] :focus-visible{outline:3px solid var(--accent);outline-offset:2px}
html[data-ui="apple"] .skinSwitch .skinSeg:focus-visible{outline:3px solid var(--accent);outline-offset:2px}
html[data-ui="apple"] .rcNum:focus{outline:3px solid var(--accent);outline-offset:2px;background:var(--card3)}
/* 排版 */
html[data-ui="apple"] h1{font-size:20px;font-weight:600;letter-spacing:-.02em;line-height:1.4}
html[data-ui="apple"] .stateHead,html[data-ui="apple"] .version,html[data-ui="apple"] .helpSection h3,html[data-ui="apple"] .stateMeta b,html[data-ui="apple"] .toggleLabel,html[data-ui="apple"] .settingsView .setRow h3{text-transform:none;letter-spacing:0;font-weight:600;font-size:13px;line-height:1.35}
html[data-ui="apple"] .stateValue{font-weight:600;letter-spacing:-.02em;line-height:1.15}
html[data-ui="apple"] .stateSub,html[data-ui="apple"] .stateMeta,html[data-ui="apple"] .stateHead{line-height:1.35}
html[data-ui="apple"] .navTabWeak{color:var(--ink3)}
html[data-ui="apple"] .stateSub,html[data-ui="apple"] .muted,html[data-ui="apple"] .recMeta,html[data-ui="apple"] .legend span,html[data-ui="apple"] .rcCell b,html[data-ui="apple"] .netTabs button{font-size:13px}
html[data-ui="apple"] .log{font-size:13px;line-height:1.45}
/* 语义色双轨：文字走 --*-text，填充（点/条/描边/canvas）保持原 token */
html[data-ui="apple"] .c1{color:var(--ok-text)}
html[data-ui="apple"] .c3{color:var(--warn-text)}
html[data-ui="apple"] .c4{color:var(--bad-text)}
html[data-ui="apple"] .c5{color:var(--drift-text)}
/* 材质与层级 */
html[data-ui="apple"] .panel{background:var(--card);border:1px solid var(--cardLine);border-radius:16px;padding:14px}
html[data-ui="apple"] .stateCard{border-color:var(--cardLine);transition:background-color .2s var(--ease-apple),border-color .2s var(--ease-apple),box-shadow .2s var(--ease-apple)}
html[data-ui="apple"] .mode0,html[data-ui="apple"] .mode1,html[data-ui="apple"] .mode2,html[data-ui="apple"] .parkUnlocked,html[data-ui="apple"] .driftOff{border-color:var(--cardLine)}
html[data-ui="apple"] .driftArmed{border-color:var(--warn)}
html[data-ui="apple"] .driftActive{border-color:var(--drift);animation-duration:2s}
html[data-ui="apple"] .driftActive:before{animation-duration:2.8s}
html[data-ui="apple"] .parkLocked{border-color:var(--bad);animation-duration:2.4s}
html[data-ui="apple"] .netDown{border-color:var(--bad)}
html[data-ui="apple"] .modal{background:var(--scrim);backdrop-filter:saturate(180%) blur(20px);-webkit-backdrop-filter:saturate(180%) blur(20px)}
html[data-ui="apple"] .dialog{background:var(--matSolid);backdrop-filter:saturate(180%) blur(20px);-webkit-backdrop-filter:saturate(180%) blur(20px);box-shadow:var(--elev)}
html[data-ui="apple"] .helpModal{background:var(--mat);backdrop-filter:saturate(180%) blur(20px);-webkit-backdrop-filter:saturate(180%) blur(20px);box-shadow:var(--elev)}
html[data-ui="apple"] .reconnectOverlay{background:var(--matSolid);backdrop-filter:saturate(180%) blur(20px);-webkit-backdrop-filter:saturate(180%) blur(20px)}
html[data-ui="apple"] .reconnectActions{margin-top:16px}
html[data-ui="apple"] .reconnectActions button{min-height:44px;border-radius:22px;padding:0 22px}
/* 发丝线（列表分隔走 separator 档）/ 圆角收敛 8·12·16·22·9999 */
html[data-ui="apple"] .settingsView .setRow{border-color:var(--sep);border-radius:16px}
html[data-ui="apple"] .rcCell{border-color:var(--cardLine);border-radius:12px}
html[data-ui="apple"] .rcCell.modeCh{border-color:var(--warn)}
html[data-ui="apple"] .foldHead{border-color:var(--cardLine)}
html[data-ui="apple"] .termTab{border-color:var(--cardLine);border-radius:8px}
html[data-ui="apple"] .termTabClose{border-radius:8px}
html[data-ui="apple"] canvas{border-color:var(--cardLine);border-radius:12px}
html[data-ui="apple"] .log{border-radius:12px}
html[data-ui="apple"] .rcNum,html[data-ui="apple"] .iconButton,html[data-ui="apple"] #cmdTarget{border-radius:8px}
html[data-ui="apple"] .dialog,html[data-ui="apple"] .helpModal,html[data-ui="apple"] .toast{border-radius:22px}
html[data-ui="apple"] .embedTuneFrame{border-radius:16px}
/* toast：底部居中毛玻璃胶囊，上移避开 FAB（原与 .helpFab 完全重叠） */
html[data-ui="apple"] .toast{left:0;right:0;inset-inline:18px;margin-inline:auto;width:fit-content;max-width:none;bottom:calc(90px + env(safe-area-inset-bottom));min-height:44px;display:inline-flex;align-items:center;justify-content:center;padding:10px 20px;background:var(--mat);backdrop-filter:saturate(180%) blur(20px);-webkit-backdrop-filter:saturate(180%) blur(20px);box-shadow:var(--elev);color:var(--ink);transform:translateY(12px);transition:opacity .28s var(--ease-apple),transform .28s var(--ease-apple)}
html[data-ui="apple"] .toast.show{transform:translateY(0)}
/* 禁用态（console 原缺） */
html[data-ui="apple"] button:disabled,html[data-ui="apple"] input:disabled,html[data-ui="apple"] select:disabled{opacity:1;background:var(--control);color:var(--ink3);border-color:var(--cardLine);cursor:not-allowed;box-shadow:none}
html[data-ui="apple"] button.alt:disabled{background:transparent}
/* #fabToggle：原 18×18 空白 → 44×44 + 可见图标（mask 图标，非 emoji） */
html[data-ui="apple"] .fabToggle{width:44px;height:44px;bottom:calc(24px + env(safe-area-inset-bottom))}
html[data-ui="apple"] .fabToggle::before{content:"";position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:20px;height:20px;background:currentColor;-webkit-mask:url("data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23000%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22M4%2014a1%201%200%200%201-.78-1.63l9.9-10.2a.5.5%200%200%201%20.86.46l-1.92%206.02A1%201%200%200%200%2013%2010h7a1%201%200%200%201%20.78%201.63l-9.9%2010.2a.5.5%200%200%201-.86-.46l1.92-6.02A1%201%200%200%200%2011%2014z%22%2F%3E%3C%2Fsvg%3E") center/contain no-repeat;mask:url("data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%23000%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpath%20d%3D%22M4%2014a1%201%200%200%201-.78-1.63l9.9-10.2a.5.5%200%200%201%20.86.46l-1.92%206.02A1%201%200%200%200%2013%2010h7a1%201%200%200%201%20.78%201.63l-9.9%2010.2a.5.5%200%200%201-.86-.46l1.92-6.02A1%201%200%200%200%2011%2014z%22%2F%3E%3C%2Fsvg%3E") center/contain no-repeat;pointer-events:none}
html[data-ui="apple"] .fabActions{bottom:calc(18px + env(safe-area-inset-bottom));right:18px}
html[data-ui="apple"] .fabActions .helpFab{bottom:0;right:0}
/* 命中区 ≥44×44：::after 不可见命中区，视觉尺寸不变 */
html[data-ui="apple"] .themeButton,html[data-ui="apple"] .langButton,html[data-ui="apple"] .muteButton,html[data-ui="apple"] .skinSeg,html[data-ui="apple"] .navTabWeak,html[data-ui="apple"] .navTab,html[data-ui="apple"] .ghLink,html[data-ui="apple"] .logoLink,html[data-ui="apple"] .titleLink,html[data-ui="apple"] .otaLink,html[data-ui="apple"] #devModeToggle,html[data-ui="apple"] .iconButton,html[data-ui="apple"] .rcSetBtn,html[data-ui="apple"] .netTabs button,html[data-ui="apple"] #driftTuneLink,html[data-ui="apple"] .foldHead,html[data-ui="apple"] .copyValue,html[data-ui="apple"] .termTab,html[data-ui="apple"] .termTabClose,html[data-ui="apple"] .helpFab,html[data-ui="apple"] .histRow{position:relative}
html[data-ui="apple"] .themeButton::after,html[data-ui="apple"] .langButton::after,html[data-ui="apple"] .muteButton::after,html[data-ui="apple"] .skinSeg::after,html[data-ui="apple"] .navTabWeak::after,html[data-ui="apple"] .navTab::after,html[data-ui="apple"] .ghLink::after,html[data-ui="apple"] .logoLink::after,html[data-ui="apple"] .titleLink::after,html[data-ui="apple"] .otaLink::after,html[data-ui="apple"] #devModeToggle::after,html[data-ui="apple"] .iconButton::after,html[data-ui="apple"] .rcSetBtn::after,html[data-ui="apple"] .netTabs button::after,html[data-ui="apple"] #driftTuneLink::after,html[data-ui="apple"] .foldHead::after,html[data-ui="apple"] .copyValue::after,html[data-ui="apple"] .gear::after{content:"";position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:max(100%,44px);height:max(100%,44px);border-radius:inherit}
/* 卡片 overflow:hidden 裁掉命中区顶部：整体下移补回 44px */
html[data-ui="apple"] .netTabs button::after{top:calc(50% + 3px)}
html[data-ui="apple"] #driftTuneLink::after{top:calc(50% + 7px)}
/* IP 复制区：改为左对齐半宽命中区（44 高），避开右上角 AP/STA/HOST 与 ⚙ 的命中带 */
html[data-ui="apple"] .copyValue::after{top:calc(50% + 3px)}
/* 相邻目标不重叠：行内 pitch ≥44（可见间距 ≥8px） */
html[data-ui="apple"] .chartToolbar{gap:18px}
html[data-ui="apple"] .row{gap:18px}
html[data-ui="apple"] .netTabs{gap:12px;z-index:3}
html[data-ui="apple"] .copyValue{z-index:1}
/* 表单控件 44px */
html[data-ui="apple"] input,html[data-ui="apple"] select,html[data-ui="apple"] textarea{min-height:44px;box-sizing:border-box}
html[data-ui="apple"] .rcNum{min-height:44px;min-width:44px}
html[data-ui="apple"] input[type=range]{height:44px}
html[data-ui="apple"] .toggleSwitch{min-height:44px;min-width:44px}
html[data-ui="apple"] .dialogActions button{min-height:44px}
html[data-ui="apple"] .histRow{min-height:44px}
/* 移动端页头：56px 标题行 + 44px 横向可滚弱入口行，两行合计 100px */
@media (max-width:820px){
html[data-ui="apple"] .headerRow{align-items:center;gap:12px;row-gap:0;margin-bottom:8px}
html[data-ui="apple"] .headerRow .rowBreak{display:none}
html[data-ui="apple"] .headerRow .br3{display:block;flex-basis:100%;height:0;order:8;margin:0}
html[data-ui="apple"] .headerLogo{order:1}
html[data-ui="apple"] .headerRow h1{order:2;display:flex;align-items:center;min-height:56px;min-width:0;flex:1 1 auto;white-space:nowrap;overflow:hidden;text-overflow:clip;margin:0}
html[data-ui="apple"] #muteToggle{order:3;margin-left:0}
html[data-ui="apple"] #themeToggle{order:4}
html[data-ui="apple"] #langToggle{order:5;margin-left:0}
html[data-ui="apple"] #versionLabel{order:6}
html[data-ui="apple"] .ghLink{order:7;margin-left:0}
html[data-ui="apple"] #skinSwitch{order:9}
html[data-ui="apple"] .headerRow .otaLink{order:10}
html[data-ui="apple"] #devModeToggle{order:11;margin-left:0}
html[data-ui="apple"] .navLinks{order:12;flex:1 1 0;min-width:96px;height:44px;align-items:center;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden;scrollbar-width:none;-ms-overflow-style:none;-webkit-mask-image:linear-gradient(90deg,#000 88%,transparent);mask-image:linear-gradient(90deg,#000 88%,transparent)}
html[data-ui="apple"] .navLinks::-webkit-scrollbar{display:none}
html[data-ui="apple"] .navLinks>*{flex:0 0 auto}
html[data-ui="apple"] .navTab,html[data-ui="apple"] .navTabWeak{min-height:44px;display:inline-flex;align-items:center;margin-right:16px}
html[data-ui="apple"] .skinSeg{padding:0 10px;min-width:44px}
}
@media (max-width:560px){
html[data-ui="apple"] .headerLogo,html[data-ui="apple"] .logoLink{display:none}
html[data-ui="apple"] .skinSeg{padding:0 8px}
}
/* 降级 */
@media (prefers-reduced-motion: reduce){
html[data-ui="apple"] *,html[data-ui="apple"] *::before,html[data-ui="apple"] *::after{animation-duration:.001ms !important;animation-iteration-count:1 !important;transition-duration:.001ms !important;scroll-behavior:auto !important}
html[data-ui="apple"] .reconnectSpinner{animation-duration:1.2s !important;animation-iteration-count:infinite !important}
}
@media (prefers-reduced-transparency: reduce){
html[data-ui="apple"] .toast,html[data-ui="apple"] .helpModal,html[data-ui="apple"] .dialog,html[data-ui="apple"] .modal,html[data-ui="apple"] .reconnectOverlay{background:var(--matSolid);backdrop-filter:none;-webkit-backdrop-filter:none}
}
@media (prefers-contrast: more){
html[data-ui="apple"]{--ink2:#f5f5f7;--ink3:#f5f5f7;--ink4:#f5f5f7;--inkPill:#f5f5f7;--inkT:#f5f5f7;--segInk:#f5f5f7;--cardLine:rgba(255,255,255,.34);--sep:rgba(255,255,255,.34)}
html[data-ui="apple"][data-theme="light"]{--ink2:#1d1d1f;--ink3:#1d1d1f;--ink4:#1d1d1f;--inkPill:#1d1d1f;--inkT:#1d1d1f;--segInk:#1d1d1f;--cardLine:rgba(60,60,67,.55);--sep:rgba(60,60,67,.55)}
html[data-ui="apple"] .toast,html[data-ui="apple"] .helpModal,html[data-ui="apple"] .dialog,html[data-ui="apple"] .modal,html[data-ui="apple"] .reconnectOverlay{background:var(--matSolid);backdrop-filter:none;-webkit-backdrop-filter:none}
}
@media (forced-colors: active){
html[data-ui="apple"] .stateCard,html[data-ui="apple"] .rcCell,html[data-ui="apple"] .panel,html[data-ui="apple"] .foldHead,html[data-ui="apple"] .log,html[data-ui="apple"] canvas{border:1px solid CanvasText}
html[data-ui="apple"] .stateDot{forced-color-adjust:none;background:CanvasText;border:1px solid Canvas}
html[data-ui="apple"] .driftBar{forced-color-adjust:none;background:Canvas;border:1px solid CanvasText}
}
/* 设置行的动作按钮（漂移设置 / Judge 设置 / 手柄校准）：原高 39px（<44），
   触屏上偏小；apple 象限提到 44（iOS 表单动作按钮的最小高度） */
html[data-ui="apple"] .setActions button {
  min-height: 44px;
}
</style>
</head>
...
<div id="diagSettingsRow" style="margin:10px 0"><button onclick="openJoystickCalModal()" data-i18n="button.joystickCal">Calibrate Joystick</button><button onclick="window.open('/drift?theme='+resolvedTheme()+'&ui='+resolvedUiStyle(),'_blank')" data-i18n="button.driftSettings" style="margin-left:8px">漂移设置</button></div>
...
function applyTheme(){document.documentElement.dataset.theme=resolvedTheme();gridReady=false;draw();const dl=document.getElementById('driftTuneLink');if(dl)dl.href='/drift?theme='+resolvedTheme()+'&ui='+resolvedUiStyle()}
...
const UI_STYLE_STORAGE_KEY='mus4.ui.style';let uiStyleOverride=null;
function readUrlUiStyle(){try{const m=/[?&]ui=(cockpit|apple)(?:&|$)/.exec(window.location.search);if(m)return m[1]}catch(e){}return null}
function readStoredUiStyle(){try{const v=localStorage.getItem(UI_STYLE_STORAGE_KEY);return v==='cockpit'||v==='apple'?v:'apple'}catch(e){return 'apple'}}
function resolvedUiStyle(){return uiStyleOverride||readUrlUiStyle()||readStoredUiStyle()}
function applyUiStyle(){const s=resolvedUiStyle();document.documentElement.dataset.ui=s;const c=document.getElementById('skinCockpit'),a=document.getElementById('skinApple');if(c)c.classList.toggle('active',s==='cockpit');if(a)a.classList.toggle('active',s==='apple')}
function setUiStyle(s){uiStyleOverride=s==='cockpit'?'cockpit':'apple';try{localStorage.setItem(UI_STYLE_STORAGE_KEY,uiStyleOverride)}catch(e){}applyUiStyle()}
...
async function refreshWifiSta(forceFill=false){try{const r=await fetch('/api/wifi-sta');const j=await r.json();if(forceFill||(!isWifiStaModalOpen()&&document.activeElement!==staSsid))staSsid.value=j.ssid||'';renderStaPasswordState(j,forceFill);if(j.connected&&j.sta_ip&&j.sta_ip!=='0.0.0.0'&&window.handoffShownForStaIp!==j.sta_ip){line('[sta-debug] refreshWifiSta sees connected IP, show handoff');showWifiStaHandoffModal(j)}else if(j.handoff_active&&j.handoff_sta_ip&&j.handoff_sta_ip!=='0.0.0.0'){showWifiStaHandoffModal(j)}else if(!j.connected){window.handoffShownForStaIp=''}return j}catch(e){line('sta config error: '+e);return null}}
...
<script>try{const m=/[?&]theme=(light|dark)(?:&|$)/.exec(window.location.search);document.documentElement.dataset.theme=m?m[1]:(window.matchMedia('(prefers-color-scheme: light)').matches?'light':'dark');let u='apple';const um=/[?&]ui=(cockpit|apple)(?:&|$)/.exec(window.location.search);if(um)u=um[1];else{const uv=localStorage.getItem('mus4.ui.style');if(uv==='cockpit'||uv==='apple')u=uv}document.documentElement.dataset.ui=u}catch(e){}</script>
<style>
body.preinit{visibility:hidden}
h1{font-size:24px;margin:0 0 6px}
:root{--bg:#101318;--ink:#e8edf2;--ink2:#8fa1b5;--ink3:#c7d2df;--ink4:#d6deea;--panel:#171c24;--card:#111820;--input:#0f1720;--line:#2b3441;--line2:#2b3441;--line3:#2b3441;--bar:#243041;--bar2:#223042;--chartBg:#0f1720;--link:#8bdcff;--accentFill:#5cc8ff;--accentHi:#8bdcff;--onAccent:#061019;--ok:#39d98a;--warn:#f59e0b;--bad:#ef4444;--bad2:#ff7b7b;--badSoft:rgba(239,68,68,.12);--badInk:#ffd3d3;--dotOff:#64748b;--heroGrad:linear-gradient(145deg,#111820,#151f2a);--fillGrad:linear-gradient(90deg,#39d98a,#5cc8ff,#8b5cf6);--dimGrad:linear-gradient(90deg,#ef4444,#f59e0b,#39d98a);--segHover:#1c2430;--segInk:#8fa1b5;--inkHi:#e8f6ff;--inkF:#8fa1b5;--accent:#5cc8ff;--segTrackBg:var(--panel);--segTrackLine:var(--line2);--segInkHi:var(--inkHi);--segThumb:var(--accentFill);--segThumbInk:var(--onAccent);--segThumbHi:var(--accentHi);--segThumbShadow:none}html[data-theme="light"]{--bg:#eef1f5;--ink:#1a2330;--ink2:#5b6b7d;--ink3:#1a2330;--ink4:#1a2330;--panel:#fff;--card:#f4f6f9;--input:#fff;--line:#d5dce4;--line2:#ccd5df;--line3:#c3ccd6;--bar:#d5dce4;--bar2:#d5dce4;--chartBg:#f4f6f9;--link:#0c9bd6;--accentFill:#0c9bd6;--accentHi:#3aa8dd;--onAccent:#fff;--heroGrad:#fff;--segHover:#e8eef5;--segInk:#5b6b7d;--inkHi:#0b2536;--inkF:#8fa1b5;--accent:#0c9bd6;--segTrackBg:var(--panel);--segTrackLine:var(--line2);--segInkHi:var(--inkHi);--segThumb:var(--accentFill);--segThumbInk:var(--onAccent);--segThumbHi:var(--accentHi);--segThumbShadow:none}html[data-ui="apple"]{--bg:#000;--ink:#f5f5f7;--ink2:rgba(235,235,245,.62);--ink3:#f5f5f7;--ink4:#f5f5f7;--panel:#1c1c1e;--card:#1c1c1e;--input:#1c1c1e;--line:rgba(255,255,255,.10);--line2:rgba(255,255,255,.10);--line3:rgba(255,255,255,.10);--bar:#2c2c2e;--bar2:#2c2c2e;--chartBg:#000;--link:#2997ff;--accentFill:#0a84ff;--accentHi:#2997ff;--onAccent:#fff;--ok:#30d158;--warn:#ff9f0a;--bad:#ff453a;--bad2:#ff6961;--badSoft:rgba(255,69,58,.15);--badInk:#ffc9c4;--dotOff:#636366;--heroGrad:#1c1c1e;--fillGrad:linear-gradient(90deg,#30d158,#2997ff,#bf5af2);--dimGrad:linear-gradient(90deg,#ff453a,#ff9f0a,#30d158);--segHover:#2c2c2e;--segInk:rgba(235,235,245,.62);--inkHi:#f5f5f7;--inkF:rgba(235,235,245,.62);--accent:#2997ff;--segTrackBg:rgba(120,120,128,.24);--segTrackLine:transparent;--segHover:transparent;--segInkHi:#f5f5f7;--segThumb:#636366;--segThumbInk:#f5f5f7;--segThumbHi:#636366;--segThumbShadow:0 1px 3px rgba(0,0,0,.35),0 1px 2px rgba(0,0,0,.35)}html[data-ui="apple"][data-theme="light"]{--bg:#f5f5f7;--ink:#1d1d1f;--ink2:rgba(60,60,67,.62);--ink3:#1d1d1f;--ink4:#1d1d1f;--panel:#fff;--card:#f5f5f7;--input:#f5f5f7;--line:rgba(0,0,0,.08);--line2:rgba(0,0,0,.08);--line3:rgba(0,0,0,.08);--bar:rgba(120,120,128,.16);--bar2:rgba(120,120,128,.16);--chartBg:#f5f5f7;--link:#0066cc;--accentFill:#0071e3;--accentHi:#0066cc;--onAccent:#fff;--ok:#34c759;--warn:#ff9500;--bad:#ff3b30;--bad2:#ff3b30;--badSoft:rgba(255,59,48,.12);--badInk:#d70015;--dotOff:#8e8e93;--heroGrad:#fff;--fillGrad:linear-gradient(90deg,#34c759,#0071e3,#af52de);--dimGrad:linear-gradient(90deg,#ff3b30,#ff9500,#34c759);--segHover:rgba(120,120,128,.16);--segInk:rgba(60,60,67,.62);--inkHi:#1d1d1f;--inkF:rgba(60,60,67,.62);--accent:#0066cc;--segTrackBg:rgba(120,120,128,.16);--segTrackLine:transparent;--segHover:transparent;--segInkHi:#1d1d1f;--segThumb:#fff;--segThumbInk:#1d1d1f;--segThumbHi:#fff;--segThumbShadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.06)}html[data-ui="apple"] h1{font-weight:600;letter-spacing:-0.02em}html[data-ui="apple"] button{font-weight:600!important;border-radius:9999px}html[data-ui="apple"] .panel,html[data-ui="apple"] .heroCard,html[data-ui="apple"] .chartWrap{border-radius:16px}html[data-ui="apple"] .card,html[data-ui="apple"] .summaryItem,html[data-ui="apple"] .collision,html[data-ui="apple"] .field{border-radius:14px}html[data-ui="apple"] .field input{border-radius:8px}html[data-ui="apple"] .value,html[data-ui="apple"] .heroValue,html[data-ui="apple"] .scoreValue,html[data-ui="apple"] .summaryItem .v,html[data-ui="apple"] .dimScore{font-weight:600;font-variant-numeric:tabular-nums}html[data-ui="apple"] .heroValue,html[data-ui="apple"] .scoreValue{letter-spacing:-0.02em}html[data-ui="apple"] .fieldTitle,html[data-ui="apple"] .sectionTitle,html[data-ui="apple"] .statusPill,html[data-ui="apple"] .dimTrend{font-weight:600}html[data-ui="apple"] button:active{transform:scale(.97)}.skinSwitch{display:inline-flex;align-items:center;gap:2px;height:28px;padding:2px;border-radius:999px;border:1px solid var(--segTrackLine);background:var(--segTrackBg);box-sizing:border-box}.skinSwitch .skinSeg{height:24px;padding:0 12px;border:none;border-radius:999px;background:transparent;color:var(--segInk);font-size:12px;font-weight:600;line-height:1;white-space:nowrap;cursor:pointer;transition:color .15s,background-color .15s}.skinSwitch .skinSeg:hover{background:var(--segHover);color:var(--segInkHi)}.skinSwitch .skinSeg.active{background:var(--segThumb);color:var(--segThumbInk);box-shadow:var(--segThumbShadow)}.skinSwitch .skinSeg.active:hover{background:var(--segThumbHi);color:var(--segThumbInk)}.skinSwitch .skinSeg:focus-visible{outline:2px solid var(--accent);outline-offset:1px}body{font-family:system-ui,sans-serif;margin:16px auto;max-width:760px;background:var(--bg);color:var(--ink);padding:0 12px}
...
<style id="apple-deep">
/* ===== Apple 深化 v1.9.3 — 全部限定 html[data-ui="apple"]；座舱象限逐值不变 ===== */
html[data-ui="apple"]{--ease-apple:cubic-bezier(.32,.72,0,1);--ok-text:#30d158;--warn-text:#ff9f0a;--bad-text:#ff453a;--status-info:rgba(235,235,245,.72);--sep:rgba(255,255,255,.16);--cardLine:rgba(255,255,255,.10);--matSolid:rgba(28,28,30,.96);--elev:0 8px 30px rgba(0,0,0,.5);--appleFont:-apple-system,BlinkMacSystemFont,system-ui,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;--appleMono:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;--ink2:rgba(235,235,245,.85);--inkF:rgba(235,235,245,.72)}
html[data-ui="apple"][data-theme="light"]{--ok-text:#1a7f37;--warn-text:#c93400;--bad-text:#d70015;--status-info:rgba(60,60,67,.72);--sep:rgba(60,60,67,.29);--cardLine:rgba(0,0,0,.08);--matSolid:rgba(245,245,247,.96);--elev:0 8px 30px rgba(0,0,0,.12);--ink2:rgba(60,60,67,.85);--segInk:rgba(60,60,67,.85);--inkF:rgba(60,60,67,.72)}
html[data-ui="apple"],html[data-ui="apple"] *{-webkit-tap-highlight-color:transparent}
html[data-ui="apple"] body{font-family:var(--appleFont);-webkit-font-smoothing:antialiased;padding-bottom:env(safe-area-inset-bottom)}
html[data-ui="apple"] button,html[data-ui="apple"] input,html[data-ui="apple"] select,html[data-ui="apple"] textarea{font-family:inherit}
html[data-ui="apple"] :focus-visible{outline:3px solid var(--accent);outline-offset:2px}
...
html[data-ui="apple"] h1{font-size:20px;font-weight:600;letter-spacing:-.02em;line-height:1.4}
html[data-ui="apple"] .fieldHint,html[data-ui="apple"] .summaryItem .k,html[data-ui="apple"] .dimName,html[data-ui="apple"] .fieldTitle,html[data-ui="apple"] .field,html[data-ui="apple"] .statusPill,html[data-ui="apple"] .sectionTitle,html[data-ui="apple"] .dimTrend{font-size:13px;line-height:1.35;text-transform:none;letter-spacing:0}
html[data-ui="apple"] .fieldHint{min-height:36px}
html[data-ui="apple"] .heroValue{font-weight:600;letter-spacing:-.02em;line-height:1.05}
html[data-ui="apple"] .scoreValue{font-weight:600;letter-spacing:-.02em}
/* 语义色双轨：文字用 --*-text，填充（点/条/渐变）保持原 token */
html[data-ui="apple"] .dimTrendUp{color:var(--ok-text)}
html[data-ui="apple"] .dimTrendDown{color:var(--bad-text)}
/* 状态双通道：颜色 + 字形 */
html[data-ui="apple"] .statusPill{gap:6px;border-color:var(--cardLine)}
html[data-ui="apple"] .statusPill::before{font-weight:700;font-size:13px;line-height:1}
html[data-ui="apple"] .statusOnline::before{content:"\2713"}
html[data-ui="apple"] .statusWaiting::before{content:"\2026"}
html[data-ui="apple"] .statusOffline::before{content:"\00d7"}
/* 材质 / 发丝线 / 圆角 8·12·16·22·9999 */
html[data-ui="apple"] .panel{background:var(--panel);border:1px solid var(--cardLine);border-radius:16px;padding:14px}
html[data-ui="apple"] .card,html[data-ui="apple"] .summaryItem{border-color:var(--cardLine);border-radius:12px}
html[data-ui="apple"] .heroCard{border-color:var(--cardLine);border-radius:16px}
html[data-ui="apple"] .field{border-color:var(--cardLine);border-radius:12px}
html[data-ui="apple"] .tuneSection{border-top:1px solid var(--sep);margin-top:16px;padding-top:16px}
html[data-ui="apple"] .chartWrap{border-color:var(--cardLine);border-radius:16px}
html[data-ui="apple"] .field input,html[data-ui="apple"] .field select{border-color:var(--cardLine);border-radius:12px}
html[data-ui="apple"] .collision{border-radius:12px}
html[data-ui="apple"] .dimRow{border-radius:8px}
html[data-ui="apple"] .row{gap:14px}
html[data-ui="apple"] .modal .dialog,html[data-ui="apple"] .dialog{border-radius:22px;background:var(--matSolid);box-shadow:var(--elev)}
/* 控件尺寸 44px + 禁用态 */
html[data-ui="apple"] button{min-height:44px;border-radius:9999px;padding:10px 18px;font-size:13px}
html[data-ui="apple"] .skinSeg,html[data-ui="apple"] .themeButton,html[data-ui="apple"] .langButton{min-height:0}
html[data-ui="apple"] .skinSeg{min-width:44px}
html[data-ui="apple"] input,html[data-ui="apple"] select,html[data-ui="apple"] textarea{min-height:44px;box-sizing:border-box}
html[data-ui="apple"] button:disabled{opacity:1;background:var(--panel);color:var(--status-info);border-color:var(--cardLine);cursor:not-allowed}
/* 命中区 ≥44×44（::after 不可见命中区，视觉尺寸不变） */
html[data-ui="apple"] .themeButton,html[data-ui="apple"] .langButton,html[data-ui="apple"] .skinSeg,html[data-ui="apple"] #backLink,html[data-ui="apple"] .dimRow{position:relative}
html[data-ui="apple"] .themeButton::after,html[data-ui="apple"] .langButton::after,html[data-ui="apple"] .skinSeg::after,html[data-ui="apple"] #backLink::after{content:"";position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:max(100%,44px);height:max(100%,44px);border-radius:inherit}
/* 动效统一 */
html[data-ui="apple"] button,html[data-ui="apple"] .skinSeg{transition:background-color .15s var(--ease-apple),color .15s var(--ease-apple),border-color .15s var(--ease-apple),transform .1s var(--ease-apple)}
html[data-ui="apple"] .statusDot{animation-duration:2.4s}
@media (max-width:640px){
html[data-ui="apple"] h1{font-size:20px}
html[data-ui="apple"] .heroValue{font-size:42px}
}
/* 降级 */
@media (prefers-reduced-motion: reduce){
html[data-ui="apple"] *,html[data-ui="apple"] *::before,html[data-ui="apple"] *::after{animation-duration:.001ms !important;animation-iteration-count:1 !important;transition-duration:.001ms !important;scroll-behavior:auto !important}
...
@media (prefers-reduced-transparency: reduce){
html[data-ui="apple"] .dialog,html[data-ui="apple"] .modal{background:var(--matSolid);backdrop-filter:none;-webkit-backdrop-filter:none}
}
@media (prefers-contrast: more){
html[data-ui="apple"]{--ink2:#f5f5f7;--inkF:#f5f5f7;--cardLine:rgba(255,255,255,.34);--sep:rgba(255,255,255,.34)}
html[data-ui="apple"][data-theme="light"]{--ink2:#1d1d1f;--inkF:#1d1d1f;--cardLine:rgba(60,60,67,.55);--sep:rgba(60,60,67,.55)}
html[data-ui="apple"] .panel,html[data-ui="apple"] .card,html[data-ui="apple"] .summaryItem,html[data-ui="apple"] .field,html[data-ui="apple"] .heroCard{border-width:1px;border-style:solid}
}
@media (forced-colors: active){
html[data-ui="apple"] .panel,html[data-ui="apple"] .card,html[data-ui="apple"] .summaryItem,html[data-ui="apple"] .field,html[data-ui="apple"] .heroCard,html[data-ui="apple"] .chartWrap{border:1px solid CanvasText}
html[data-ui="apple"] .statusDot{forced-color-adjust:none;background:CanvasText;border:1px solid Canvas}
}
/* 设置行的动作按钮（漂移设置 / Judge 设置 / 手柄校准）：原高 39px（<44），
   触屏上偏小；apple 象限提到 44（iOS 表单动作按钮的最小高度） */
html[data-ui="apple"] .setActions button {
...
const LANG_STORAGE_KEY='mus4.ui.lang';
const I18N={zh:{},en:{}};
I18N.zh['judge.backLink']='返回 Drifter Console';I18N.en['judge.backLink']='Back to Drifter Console';I18N.zh['theme.title']='主题';I18N.en['theme.title']='Theme';I18N.zh['language.title']='语言';I18N.en['language.title']='Language';I18N.zh['uiStyle.title']='切换 UI 风格';I18N.en['uiStyle.title']='Switch UI style';I18N.zh['uiStyle.cockpit']='座舱';I18N.en['uiStyle.cockpit']='Cockpit';I18N.zh['uiStyle.apple']='Apple';I18N.en['uiStyle.apple']='Apple';
...
function readUrlUiStyle(){try{const m=/[?&]ui=(cockpit|apple)(?:&|$)/.exec(window.location.search);if(m)return m[1]}catch(e){}return null}
function readStoredUiStyle(){try{const v=localStorage.getItem(UI_STYLE_STORAGE_KEY);return v==='cockpit'||v==='apple'?v:'apple'}catch(e){return 'apple'}}
function readParentUiStyle(){try{const s=window.parent&&window.parent.document&&window.parent.document.documentElement.dataset.ui;return s==='cockpit'||s==='apple'?s:null}catch(e){return null}}
function resolvedUiStyle(){return uiStyleOverride||readUrlUiStyle()||readParentUiStyle()||readStoredUiStyle()}
function applyUiStyle(){const s=resolvedUiStyle();document.documentElement.dataset.ui=s;const c=document.getElementById('skinCockpit'),a=document.getElementById('skinApple');if(c)c.classList.toggle('active',s==='cockpit');if(a)a.classList.toggle('active',s==='apple');syncBackLink()}
function setUiStyle(s){uiStyleOverride=s==='cockpit'?'cockpit':'apple';try{localStorage.setItem(UI_STYLE_STORAGE_KEY,uiStyleOverride)}catch(e){}applyUiStyle()}
function applyTheme(){document.documentElement.dataset.theme=resolvedTheme();drawChart();syncBackLink()}
function toggleTheme(){setTheme(resolvedTheme()==='light'?'dark':'light')}
function setTheme(theme){uiTheme=theme;applyTheme()}
function syncBackLink(){const bl=document.getElementById('backLink');if(bl)bl.href='/?theme='+resolvedTheme()+'&ui='+resolvedUiStyle()}
function renderLangButton(){const b=document.getElementById('langToggle');if(b)b.textContent=uiLang==='zh'?'中':'EN'}
function setLanguage(lang){uiLang=normalizeLanguage(lang);writeStoredLanguage(uiLang);applyLanguage(uiLang);fetch('/api/language?lang='+uiLang,{method:'POST'}).catch(()=>{})}
function toggleLanguage(){setLanguage(uiLang==='zh'?'en':'zh')}
...
if(location.search.indexOf('embedded=1')>=0)document.body.classList.add('embedded');syncJudgeConfigInputs();initTheme();applyUiStyle();drawChart();renderScore();initLanguage();loadJudgeConfig();connectJudgeSocket();setTimeout(()=>{if(!dataWsConnected)pollJudgeData()},1200);
</script>
</body>
</html>
)rawliteral";

static const char WIFI_WEB_DRIFT_HTML[] PROGMEM = R"rawliteral(
<!doctype html>
<html data-ui="apple">
<head>
<meta charset="utf-8">
...
html[data-ui="apple"] h1{font-size:20px;font-weight:600;letter-spacing:-.02em;line-height:1.4}
html[data-ui="apple"] .version,html[data-ui="apple"] .label,html[data-ui="apple"] .fieldTitle,html[data-ui="apple"] .fieldHint,html[data-ui="apple"] .field,html[data-ui="apple"] .summaryItem .k,html[data-ui="apple"] .tuneSection .sectionTitle,html[data-ui="apple"] .muted{font-size:13px;line-height:1.35;text-transform:none;letter-spacing:0}
html[data-ui="apple"] .fieldHint{min-height:36px}
html[data-ui="apple"] .summaryItem .v{font-weight:600;font-variant-numeric:tabular-nums;letter-spacing:-.02em}
/* 材质 / 发丝线 / 圆角 8·12·16·22·9999 */
html[data-ui="apple"] .panel,html[data-ui="apple"][data-theme="light"] .panel{background:var(--panel);border:1px solid var(--cardLine);border-radius:16px;padding:14px}
html[data-ui="apple"] .summaryItem,html[data-ui="apple"] .field{border-color:var(--cardLine);border-radius:12px}
html[data-ui="apple"] .field input,html[data-ui="apple"] .field select{border-color:var(--cardLine);border-radius:12px}
html[data-ui="apple"] .tuneSection{border-top:1px solid var(--sep)}
html[data-ui="apple"] .dialog{border-radius:22px;background:var(--matSolid);box-shadow:var(--elev)}
/* 控件尺寸 44px + 禁用态 */
html[data-ui="apple"] button{min-height:44px;border-radius:9999px;padding:10px 18px;font-size:13px}
html[data-ui="apple"] .skinSeg,html[data-ui="apple"] .themeButton,html[data-ui="apple"] .langButton{min-height:0}
html[data-ui="apple"] .skinSeg{min-width:44px}
html[data-ui="apple"] input,html[data-ui="apple"] select,html[data-ui="apple"] textarea{min-height:44px;box-sizing:border-box}
html[data-ui="apple"] button:disabled{opacity:1;background:transparent;color:var(--status-info);border-color:var(--cardLine);cursor:not-allowed}
/* 命中区 ≥44×44（::after 不可见命中区，视觉尺寸不变） */
html[data-ui="apple"] .themeButton,html[data-ui="apple"] .langButton,html[data-ui="apple"] .skinSeg,html[data-ui="apple"] #backLink{position:relative}
html[data-ui="apple"] .themeButton::after,html[data-ui="apple"] .langButton::after,html[data-ui="apple"] .skinSeg::after,html[data-ui="apple"] #backLink::after{content:"";position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:max(100%,44px);height:max(100%,44px);border-radius:inherit}
/* 动效统一 */
html[data-ui="apple"] button,html[data-ui="apple"] .skinSeg{transition:background-color .15s var(--ease-apple),color .15s var(--ease-apple),border-color .15s var(--ease-apple),transform .1s var(--ease-apple)}
html[data-ui="apple"] .summaryItem,html[data-ui="apple"] .field{transition:background-color .2s var(--ease-apple),border-color .2s var(--ease-apple)}
@media (prefers-reduced-motion: reduce){
html[data-ui="apple"] *,html[data-ui="apple"] *::before,html[data-ui="apple"] *::after{animation-duration:.001ms !important;animation-iteration-count:1 !important;transition-duration:.001ms !important;scroll-behavior:auto !important}
}
@media (prefers-reduced-transparency: reduce){
html[data-ui="apple"] .dialog{background:var(--matSolid);backdrop-filter:none;-webkit-backdrop-filter:none}
}
@media (prefers-contrast: more){
html[data-ui="apple"]{--ink2:#f5f5f7;--inkF:#f5f5f7;--cardLine:rgba(255,255,255,.34);--sep:rgba(255,255,255,.34)}
html[data-ui="apple"][data-theme="light"]{--ink2:#1d1d1f;--inkF:#1d1d1f;--cardLine:rgba(60,60,67,.55);--sep:rgba(60,60,67,.55)}
html[data-ui="apple"] .panel,html[data-ui="apple"] .summaryItem,html[data-ui="apple"] .field{border-width:1px;border-style:solid}
}
@media (forced-colors: active){
html[data-ui="apple"] .panel,html[data-ui="apple"] .summaryItem,html[data-ui="apple"] .field{border:1px solid CanvasText}
}
/* 设置行的动作按钮（漂移设置 / Judge 设置 / 手柄校准）：原高 39px（<44），
   触屏上偏小；apple 象限提到 44（iOS 表单动作按钮的最小高度） */
html[data-ui="apple"] .setActions button {
...
if(location.search.indexOf('embedded=1')>=0)document.body.classList.add('embedded');initLanguage();initTheme();applyUiStyle();loadDriftConfig();setInterval(pollDriftData,250);
</script>
</body>
</html>
)rawliteral";
...
<script>try{const m=/[?&]theme=(light|dark)(?:&|$)/.exec(window.location.search);document.documentElement.dataset.theme=m?m[1]:(window.matchMedia('(prefers-color-scheme: light)').matches?'light':'dark');let u='apple';const um=/[?&]ui=(cockpit|apple)(?:&|$)/.exec(window.location.search);if(um)u=um[1];else{const uv=localStorage.getItem('mus4.ui.style');if(uv==='cockpit'||uv==='apple')u=uv}document.documentElement.dataset.ui=u}catch(e){}</script>
<style>
:root{--bg:#101318;--ink:#e8edf2;--panel:#171c24;--panelHi:#1c2430;--line:#475569;--line2:#475569;--bar:#2b3441;--accent:#5cc8ff;--accentFill:#5cc8ff;--accentHi:#8bdcff;--onAccent:#0f1419;--segInk:#8fa1b5;--inkHi:#e8f6ff;--segHover:#222b36;--muted:#8fa1b5;--muted2:#667;--ok:#39d98a;--bad:#ff6666;--segTrackBg:var(--panel);--segTrackLine:var(--line2);--segInkHi:var(--inkHi);--segThumb:var(--accentFill);--segThumbInk:var(--onAccent);--segThumbHi:var(--accentHi);--segThumbShadow:none}html[data-theme="light"]{--bg:#eef1f5;--ink:#1a2330;--panel:#fff;--panelHi:#f4f6f9;--line:#ccd5df;--line2:#ccd5df;--bar:#d5dce4;--accent:#0c9bd6;--accentFill:#0c9bd6;--accentHi:#3aa8dd;--onAccent:#fff;--segInk:#5b6b7d;--inkHi:#0b2536;--segHover:#e8eef5;--muted:#5b6b7d;--muted2:#9aa7b4;--ok:#1fae6b;--bad:#e5484d;--segTrackBg:var(--panel);--segTrackLine:var(--line2);--segInkHi:var(--inkHi);--segThumb:var(--accentFill);--segThumbInk:var(--onAccent);--segThumbHi:var(--accentHi);--segThumbShadow:none}html[data-ui="apple"]{--bg:#000;--ink:#f5f5f7;--panel:#1c1c1e;--panelHi:#2c2c2e;--line:rgba(255,255,255,.18);--line2:rgba(255,255,255,.10);--bar:#2c2c2e;--accent:#2997ff;--accentFill:#0a84ff;--accentHi:#2997ff;--onAccent:#fff;--segInk:rgba(235,235,245,.62);--inkHi:#f5f5f7;--segHover:#2c2c2e;--muted:rgba(235,235,245,.62);--muted2:rgba(235,235,245,.5);--ok:#30d158;--bad:#ff453a;--segTrackBg:rgba(120,120,128,.24);--segTrackLine:transparent;--segHover:transparent;--segInkHi:#f5f5f7;--segThumb:#636366;--segThumbInk:#f5f5f7;--segThumbHi:#636366;--segThumbShadow:0 1px 3px rgba(0,0,0,.35),0 1px 2px rgba(0,0,0,.35)}html[data-ui="apple"][data-theme="light"]{--bg:#f5f5f7;--ink:#1d1d1f;--panel:#fff;--panelHi:#f5f5f7;--line:rgba(0,0,0,.08);--line2:rgba(0,0,0,.08);--bar:rgba(120,120,128,.16);--accent:#0066cc;--accentFill:#0071e3;--accentHi:#0066cc;--onAccent:#fff;--segInk:rgba(60,60,67,.62);--inkHi:#1d1d1f;--muted:rgba(60,60,67,.62);--muted2:rgba(60,60,67,.5);--ok:#34c759;--bad:#ff3b30;--segTrackBg:rgba(120,120,128,.16);--segTrackLine:transparent;--segHover:transparent;--segInkHi:#1d1d1f;--segThumb:#fff;--segThumbInk:#1d1d1f;--segThumbHi:#fff;--segThumbShadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.06)}html[data-ui="apple"] h1{font-weight:600;letter-spacing:-0.02em}html[data-ui="apple"] button{font-weight:600!important;border-radius:9999px}html[data-ui="apple"] #drop{border-radius:16px}html[data-ui="apple"] button:active{transform:scale(.97)}.skinSwitch{display:inline-flex;align-items:center;gap:2px;height:28px;padding:2px;border-radius:999px;border:1px solid var(--segTrackLine);background:var(--segTrackBg);box-sizing:border-box}.skinSwitch .skinSeg{height:24px;padding:0 12px;border:none;border-radius:999px;background:transparent;color:var(--segInk);font-size:12px;font-weight:600;line-height:1;white-space:nowrap;cursor:pointer;transition:color .15s,background-color .15s}.skinSwitch .skinSeg:hover{background:var(--segHover);color:var(--segInkHi)}.skinSwitch .skinSeg.active{background:var(--segThumb);color:var(--segThumbInk);box-shadow:var(--segThumbShadow)}.skinSwitch .skinSeg.active:hover{background:var(--segThumbHi);color:var(--segThumbInk)}.skinSwitch .skinSeg:focus-visible{outline:2px solid var(--accent);outline-offset:1px}.headerRow{display:flex;align-items:center;gap:6px;margin:0 0 16px;flex-wrap:wrap}.headerRow h1{margin:0}body{font-family:system-ui,sans-serif;margin:24px auto;max-width:480px;background:var(--bg);color:var(--ink);padding:0 12px;box-sizing:border-box}
...
<style id="apple-deep">
/* ===== Apple 深化 v1.9.3 — 全部限定 html[data-ui="apple"]；座舱象限逐值不变 ===== */
html[data-ui="apple"]{--ease-apple:cubic-bezier(.32,.72,0,1);--ok-text:#30d158;--warn-text:#ff9f0a;--bad-text:#ff453a;--status-info:rgba(235,235,245,.72);--sep:rgba(255,255,255,.16);--cardLine:rgba(255,255,255,.10);--matSolid:rgba(28,28,30,.96);--elev:0 8px 30px rgba(0,0,0,.5);--appleFont:-apple-system,BlinkMacSystemFont,system-ui,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;--appleMono:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;--line:rgba(255,255,255,.10);--line2:rgba(255,255,255,.10);--muted:rgba(235,235,245,.85);--muted2:rgba(235,235,245,.72)}
html[data-ui="apple"][data-theme="light"]{--ok-text:#1a7f37;--warn-text:#c93400;--bad-text:#d70015;--status-info:rgba(60,60,67,.72);--sep:rgba(60,60,67,.29);--cardLine:rgba(0,0,0,.08);--matSolid:rgba(245,245,247,.96);--elev:0 8px 30px rgba(0,0,0,.12);--line:rgba(0,0,0,.08);--line2:rgba(0,0,0,.08);--muted:rgba(60,60,67,.85);--muted2:rgba(60,60,67,.72);--segInk:rgba(60,60,67,.85)}
html[data-ui="apple"],html[data-ui="apple"] *{-webkit-tap-highlight-color:transparent}
html[data-ui="apple"] body{font-family:var(--appleFont);-webkit-font-smoothing:antialiased;padding-bottom:env(safe-area-inset-bottom)}
html[data-ui="apple"] button,html[data-ui="apple"] input,html[data-ui="apple"] select,html[data-ui="apple"] textarea{font-family:inherit}
html[data-ui="apple"] :focus-visible{outline:3px solid var(--accent);outline-offset:2px}
...
html[data-ui="apple"] h1{font-size:20px;font-weight:600;letter-spacing:-.02em;line-height:1.4}
html[data-ui="apple"] .muted,html[data-ui="apple"] #status{font-size:13px;line-height:1.35}
/* #drop：2px 虚线 → 实线发丝线 + 材质容器 */
html[data-ui="apple"] #drop{border:1px solid var(--sep);border-radius:16px;background:var(--panel);padding:44px 20px}
html[data-ui="apple"] #drop.dragover{border-color:var(--accent);background:var(--panelHi)}
/* 按钮：单一圆角来源（原 9999!important 与 6px 两条冲突规则）22px 胶囊 + ≥44px */
html[data-ui="apple"] button{min-height:44px;border-radius:22px;padding:10px 22px;font-size:15px;transition:background-color .15s var(--ease-apple),color .15s var(--ease-apple),transform .1s var(--ease-apple)}
html[data-ui="apple"] .skinSeg,html[data-ui="apple"] .themeButton,html[data-ui="apple"] .langButton{min-height:0;border-radius:9999px;padding:0}
html[data-ui="apple"] .skinSeg{min-width:44px;padding:0 12px}
html[data-ui="apple"] .headerRow{gap:14px}
html[data-ui="apple"] button:disabled{opacity:1;background:var(--panel);color:var(--muted2);border:1px solid var(--line);cursor:not-allowed}
html[data-ui="apple"] #progress{height:8px;border-radius:8px;background:var(--bar)}
html[data-ui="apple"] #progressBar{border-radius:8px;transition:width .2s var(--ease-apple)}
/* 返回链接：iOS 返回样式 */
html[data-ui="apple"] #backLink{display:inline-flex;align-items:center;gap:6px;color:var(--accent);font-size:15px !important;font-weight:500;text-decoration:none}
html[data-ui="apple"] #backLink::before{content:"";width:9px;height:9px;border-left:2px solid currentColor;border-bottom:2px solid currentColor;transform:rotate(45deg) translate(1px,-1px);border-radius:1px;flex:0 0 auto}
/* 命中区 ≥44×44（::after 不可见命中区，视觉尺寸不变） */
html[data-ui="apple"] .themeButton,html[data-ui="apple"] .langButton,html[data-ui="apple"] .skinSeg,html[data-ui="apple"] #backLink{position:relative}
html[data-ui="apple"] .themeButton::after,html[data-ui="apple"] .langButton::after,html[data-ui="apple"] .skinSeg::after,html[data-ui="apple"] #backLink::after{content:"";position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:max(100%,44px);height:max(100%,44px);border-radius:inherit}
@media (prefers-reduced-motion: reduce){
...
@media (prefers-reduced-transparency: reduce){
html[data-ui="apple"] #drop{background:var(--panel);backdrop-filter:none;-webkit-backdrop-filter:none}
}
@media (prefers-contrast: more){
html[data-ui="apple"]{--muted:#f5f5f7;--muted2:#f5f5f7;--line:rgba(255,255,255,.34);--sep:rgba(255,255,255,.34)}
html[data-ui="apple"][data-theme="light"]{--muted:#1d1d1f;--muted2:#1d1d1f;--line:rgba(60,60,67,.55);--sep:rgba(60,60,67,.55)}
html[data-ui="apple"] #drop{border-width:1px;border-style:solid}
}
@media (forced-colors: active){
html[data-ui="apple"] #drop{border:1px solid CanvasText}
}
/* 设置行的动作按钮（漂移设置 / Judge 设置 / 手柄校准）：原高 39px（<44），
   触屏上偏小；apple 象限提到 44（iOS 表单动作按钮的最小高度） */
html[data-ui="apple"] .setActions button {
...
<body>
<div class="headerRow"><h1 data-i18n="ota.heading">MUS4 HTTP OTA</h1><a id="backLink" href="/" data-i18n="ota.backLink" style="margin-left:auto;font-size:12px">返回 Drifter Console</a><div id="skinSwitch" class="skinSwitch" role="group" aria-label="切换 UI 风格" data-i18n-aria="uiStyle.title"><button id="skinCockpit" type="button" class="skinSeg" onclick="setUiStyle('cockpit')" data-i18n="uiStyle.cockpit">座舱</button><button id="skinApple" type="button" class="skinSeg" onclick="setUiStyle('apple')" data-i18n="uiStyle.apple">Apple</button></div><button type="button" id="themeToggle" class="themeButton" onclick="toggleTheme()" aria-label="主题" data-i18n-aria="theme.title"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><g class="icoMoon"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></g><g class="icoSun"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></g></svg></button><button type="button" id="langToggle" class="langButton" onclick="toggleLanguage()" aria-label="语言" data-i18n-aria="language.title">中</button></div>
<div id="drop">
...
initLanguage();initTheme();applyUiStyle();
</script>
</body>
</html>
)rawliteral";
