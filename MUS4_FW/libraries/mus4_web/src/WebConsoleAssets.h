...
<style>
body{font-family:system-ui,sans-serif;margin:12px;background:#101318;color:#e8edf2}h1{margin:0;font-size:22px}.headerRow{display:flex;align-items:flex-end;gap:12px;flex-wrap:wrap;margin:0 0 10px}.version{color:#8fa1b5;font-size:12px;text-transform:uppercase;letter-spacing:.08em;display:inline-block;transform:translateY(-1px)}.toggleSwitch{position:relative;display:inline-flex;align-items:center;gap:8px;cursor:pointer}.toggleSwitch input{opacity:0;width:0;height:0;position:absolute}.slider{position:relative;width:44px;height:24px;background:#475569;border-radius:999px;transition:.25s}.slider:before{content:"";position:absolute;height:18px;width:18px;left:3px;bottom:3px;background:#fff;border-radius:50%;transition:.25s}.toggleSwitch input:checked+.slider{background:#5cc8ff}.toggleSwitch input:checked+.slider:before{transform:translateX(20px)}.toggleLabel{color:#8fa1b5;font-size:12px;text-transform:uppercase;letter-spacing:.08em}.devHint{position:relative}.devHint:hover:after{content:'开发模式会持久化；Web Console 免 AUTH，但仍保留 Park Locked 安全限制。OTA 传输期间会默认 Park Locked。';position:absolute;right:0;top:26px;width:280px;background:#111820;border:1px solid #5cc8ff;border-radius:10px;padding:8px 10px;color:#dbeafe;font-size:12px;font-weight:600;line-height:1.45;text-transform:none;letter-spacing:0;white-space:normal;z-index:6}.otaLink{margin-left:auto;text-decoration:none}.otaButton{background:#5cc8ff;color:#061019;border-color:#5cc8ff;font-weight:800;font-size:11px;padding:0 10px;min-width:0;height:24px;border-radius:999px;line-height:1}.otaButton:hover{background:#8bdcff}.grid{display:grid;grid-template-columns:1fr;gap:10px}.panel{background:#171c24;border:1px solid #2b3441;border-radius:8px;padding:10px}#status{white-space:pre-wrap;color:#b7c6d8;font-size:13px;margin-top:10px}.fold{margin-top:10px}.foldHead{width:100%;display:flex;align-items:center;gap:6px;text-align:left;background:#111820;border:1px solid #2b3441;color:#dbeafe}.foldHead:hover{background:#17202b}.foldIcon{display:inline-block;width:16px;color:#93c5fd}.fold:not(.open) .foldBody{display:none}.statusTable{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:4px 12px}.statusRow{display:grid;grid-template-columns:minmax(100px,auto) 1fr;gap:10px;align-items:start}.statusRow b{color:#8fa1b5;font-weight:700}.statusRow span{font:13px Consolas,monospace;color:#e8edf2;overflow-wrap:anywhere}.stateGrid{display:grid;gap:10px;align-items:stretch;grid-template-columns:minmax(96px,.30fr) minmax(160px,.56fr) minmax(260px,1.30fr) minmax(112px,.30fr) minmax(220px,.80fr);grid-template-areas:"mode park drift voltage network"}#modeCard{grid-area:mode}#parkCard{grid-area:park}#driftCard{grid-area:drift}#voltageCard{grid-area:voltage}#networkCard{grid-area:network}.stateCard{position:relative;overflow:hidden;border:1px solid #344154;border-radius:10px;padding:12px;background:linear-gradient(135deg,#1c2430,#121821);box-shadow:0 0 0 rgba(0,0,0,0);transition:.25s}.stateHead{color:#8fa1b5;font-size:12px;text-transform:uppercase;letter-spacing:.08em}.stateValue{font-size:24px;font-weight:800;margin-top:4px;white-space:normal;overflow:visible;text-overflow:clip;word-break:normal;overflow-wrap:normal;line-height:1.08}.copyValue{cursor:pointer;position:relative}.copyValue:hover{color:#5cc8ff}.copyValue:hover:after{content:'点击复制 IP';position:absolute;left:72px;top:-26px;background:#111820;border:1px solid #5cc8ff;border-radius:8px;padding:4px 8px;color:#dbeafe;font-size:12px;font-weight:600;white-space:nowrap;pointer-events:none;z-index:4}.stateSub{color:#b7c6d8;font-size:12px;margin-top:3px;white-space:normal;overflow:visible;text-overflow:clip;word-break:normal;overflow-wrap:normal;line-height:1.25}.stateDot{position:absolute;right:12px;top:12px;width:10px;height:10px;border-radius:50%;background:#667}.gear{position:absolute;right:10px;top:32px;width:30px;height:30px;min-width:0;padding:0;border-radius:50%;font-size:16px;line-height:1;z-index:6}.netTabs{position:absolute;right:28px;top:8px;display:flex;gap:4px}.netTabs button{min-width:0;padding:2px 8px;border-radius:999px;font-size:11px;line-height:1.2}.netTabs button.active{background:#5cc8ff;color:#061019;font-weight:800}.stateMeta{display:grid;grid-template-columns:1fr;gap:3px;margin-top:8px;font-size:12px}.stateMeta b{color:#8fa1b5;font-size:11px;letter-spacing:.08em;text-transform:uppercase}.stateMeta span{font-size:15px;font-weight:700;white-space:normal;overflow:visible;text-overflow:clip;word-break:normal;overflow-wrap:normal;line-height:1.2}#networkCard .stateValue,#networkCard .stateMeta span,#driftCard .stateSub{overflow-wrap:anywhere}.mode0{border-color:#39d98a}.mode1{border-color:#ffcc66}.mode2{border-color:#5cc8ff}.mode0 .stateDot{background:#39d98a}.mode1 .stateDot{background:#ffcc66}.mode2 .stateDot{background:#5cc8ff}.parkLocked{border-color:#ff6b6b;animation:pulse 1.2s infinite}.parkUnlocked{border-color:#39d98a}.parkLocked .stateDot{background:#ff6b6b}.parkUnlocked .stateDot{background:#39d98a}.driftOff{border-color:#475569}.driftArmed{border-color:#ffcc66}.driftActive{border-color:#d96bff;animation:pulse 1s infinite}.driftBar{height:6px;background:#273142;border-radius:999px;margin-top:10px;position:relative}.driftBar i{position:absolute;top:-3px;width:4px;height:12px;background:#d96bff;border-radius:2px;left:50%;transition:left .2s}.driftActive:before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,transparent,rgba(217,107,255,.16),transparent);animation:scan 1.4s infinite}.rcGrid{display:grid;grid-template-columns:repeat(6,minmax(72px,1fr));gap:6px;margin-top:10px}.rcCell{background:#0d1219;border:1px solid #2b3441;border-radius:8px;padding:8px;text-align:center}.rcCell b{display:block;color:#8fa1b5;font-size:11px}.rcCell span{font:700 18px Consolas,monospace}.rcCell.modeCh{border-color:#ffcc66}.row{display:flex;gap:6px;flex-wrap:nowrap;align-items:center}#cmd{flex:1;min-width:0}#cmdTarget{font-size:15px;border-radius:6px;border:1px solid #3b4655;background:#222b36;color:#eef;padding:8px;flex:0 0 auto}button,input,select{font-size:15px;border-radius:6px;border:1px solid #3b4655;background:#222b36;color:#eef;padding:8px}button{cursor:pointer}button:hover{background:#2d3948}input{flex:0 1 180px;min-width:120px;max-width:220px}.formRow{display:flex;gap:8px;align-items:center;margin-top:8px}.formRow label{width:42px;color:#8fa1b5;font-size:13px;font-weight:700;text-align:right}.inputWithAction{position:relative;display:flex;gap:6px;align-items:center;flex:1}.inputWithAction input{flex:1;min-width:0;max-width:none}.iconButton{min-width:0;width:26px;height:26px;padding:0;border-radius:6px;display:inline-flex;align-items:center;justify-content:center}.scanPopover{display:none;position:absolute;left:0;right:0;top:42px;max-height:210px;overflow:auto;background:#111820;border:1px solid #5cc8ff;border-radius:10px;padding:8px;z-index:12}.scanPopover.show{display:block}.scanRow{display:flex;justify-content:space-between;gap:8px;width:100%;text-align:left;margin-top:4px}.scanMeta{color:#8fa1b5;font-size:12px;white-space:nowrap}.modal{position:fixed;inset:0;display:none;align-items:center;justify-content:center;background:rgba(5,7,10,.72);z-index:10}.modal.show{display:flex}.toast{position:fixed;right:18px;bottom:18px;background:#111820;border:1px solid #39d98a;border-radius:12px;padding:12px 14px;box-shadow:0 12px 40px rgba(0,0,0,.35);color:#e8edf2;opacity:0;transform:translateY(12px);transition:.25s;pointer-events:none;z-index:20}.toast.show{opacity:1;transform:translateY(0)}.helpFab{position:fixed;right:18px;bottom:18px;width:46px;height:46px;min-width:0;padding:0;border-radius:50%;background:rgba(92,200,255,.62);color:#061019;border-color:rgba(92,200,255,.72);font-size:24px;font-weight:900;line-height:1;z-index:17;box-shadow:0 8px 22px rgba(0,0,0,.22);backdrop-filter:blur(4px)}.helpFab:hover,.helpFab:focus-visible{background:#8bdcff;border-color:#8bdcff;box-shadow:0 12px 32px rgba(0,0,0,.35)}.helpOverlay{position:fixed;inset:0;display:none;background:rgba(5,7,10,.45);z-index:18}.helpOverlay.show{display:block}.helpModal{position:fixed;right:18px;bottom:74px;width:min(340px,calc(100vw - 36px));display:none;background:linear-gradient(135deg,#1c2430,#121821);border:1px solid #5cc8ff;border-radius:14px;padding:14px;box-shadow:0 18px 60px rgba(0,0,0,.45);z-index:19}.helpModal.show{display:block}.helpHead{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:8px}.helpClose{min-width:0;width:30px;height:30px;padding:0;border-radius:50%;font-size:18px;line-height:1}.helpList{margin:0;padding-left:18px;color:#dbeafe;font-size:13px;line-height:1.55}.dialog{width:min(420px,calc(100vw - 28px));background:linear-gradient(135deg,#1c2430,#121821);border:1px solid #ffcc66;border-radius:14px;padding:18px;box-shadow:0 18px 60px rgba(0,0,0,.45)}.dialog h2{margin:0 0 8px;font-size:20px}.dialog p{color:#b7c6d8;font-size:14px;line-height:1.5}.dialogActions{display:flex;gap:8px;justify-content:flex-end;margin-top:14px}.chartFooter{display:flex;gap:10px;align-items:center;justify-content:space-between;flex-wrap:wrap;margin-top:8px}.chartToolbar{display:flex;gap:6px;align-items:center}.chartTools{display:flex;gap:6px;flex-wrap:wrap;justify-content:flex-end;margin-top:8px}#tubRecordBtn.recording{color:#ff4444}#serialPanel{display:flex;flex-direction:column;gap:8px;padding-bottom:6px}.log{height:calc(5 * 1.35em + 16px);overflow:auto;background:#05070a;color:#d7ffe0;font:13px/1.35 Consolas,monospace;padding:8px;border-radius:6px;white-space:pre-wrap}#serialPanel .log{flex:1 1 auto;min-height:calc(5 * 1.35em + 16px);max-height:calc(20 * 1.35em + 16px)}.muted{color:#8fa1b5;font-size:12px}canvas{width:100%;height:auto;aspect-ratio:38/13;background:#070a0f;border-radius:6px;border:1px solid #2b3441}.legend{display:flex;gap:18px;align-items:flex-start;flex-wrap:wrap}.legend span{display:inline-block;font-size:12px}.legend b{display:block;color:inherit;font:700 13px Consolas,monospace;margin-top:2px}.recMeta{display:inline-flex;flex-direction:column;align-items:flex-start;font-size:12px;color:#8fa1b5;margin-left:4px;line-height:1.1}.recMeta b{display:block;color:#e8edf2;font:700 13px Consolas,monospace;margin-top:2px}#chartPanel:fullscreen{background:#101318;padding:12px;display:flex;flex-direction:column}#chartPanel:fullscreen .chartCanvasWrap{width:min(100%,calc((100vh - 118px) * 38 / 13))}#chartPanel:fullscreen canvas{width:100%;height:auto;max-height:calc(100vh - 118px);aspect-ratio:38/13}.c1{color:#39d98a}.c2{color:#5cc8ff}.c3{color:#ffcc66}.c4{color:#ff6b6b}.c5{color:#d96bff}.c6{color:#f472b6}.c7{color:#a3e635}.c8{color:#fb923c}@keyframes pulse{50%{box-shadow:0 0 18px rgba(255,107,107,.35);transform:translateY(-1px)}}@keyframes scan{from{transform:translateX(-100%)}to{transform:translateX(100%)}}@media(max-width:900px){.statusTable{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:860px){.stateGrid{grid-template-columns:minmax(96px,.30fr) minmax(160px,.56fr) minmax(260px,1.30fr);grid-template-areas:"mode park drift" "voltage network network"}}@media(max-width:620px){.stateGrid{grid-template-columns:84px 154px 100px;grid-template-areas:"mode park voltage" "drift drift drift" "network network network"}#modeCard,#parkCard,#voltageCard{padding:10px 8px}#modeCard .stateValue,#parkCard .stateValue,#voltageCard .stateValue,#driftCard .stateValue,#networkCard .stateValue{font-size:18px}#modeCard .stateSub,#parkCard .stateSub,#driftCard .stateSub{font-size:11px}#voltageCard .stateMeta span,#networkCard .stateMeta span{font-size:13px}#modeCard .stateHead,#parkCard .stateHead,#voltageCard .stateHead,#driftCard .stateHead,#networkCard .stateHead{font-size:11px}.rcGrid{grid-template-columns:repeat(3,minmax(72px,1fr))}}@media(max-width:560px){.statusTable{grid-template-columns:1fr}}@media(min-width:900px){.grid{grid-template-columns:2fr 1fr}.wide{grid-column:1/-1}#diagnosticsPanel{grid-column:1/-1}}.chartCanvasWrap{position:relative}#chartFullscreenBtn{position:absolute;right:8px;bottom:8px;z-index:2}
</style>
<style>
.fabToggle{position:fixed;right:24px;bottom:24px;width:18px;height:18px;min-width:0;padding:0;border-radius:50%;background:#8bdcff;border-color:#8bdcff;z-index:17;box-shadow:0 0 18px #5cc8ff,0 0 36px rgba(92,200,255,.55)}.fabToggle:hover,.fabToggle:focus-visible,.fabToggle:active{background:#8bdcff;border-color:#8bdcff;transform:scale(1.18);box-shadow:0 0 22px #8bdcff,0 0 44px rgba(92,200,255,.72)}.fabActions{position:fixed;right:18px;bottom:18px;z-index:17;pointer-events:none}.fabActions .langFab,.fabActions .helpFab{position:absolute;right:0;bottom:0;opacity:0;transform:scale(.55);pointer-events:none;transition:opacity .18s,transform .18s}.fabActions.show .langFab{opacity:1;transform:translateY(-56px) scale(1);pointer-events:auto}.fabActions.show .helpFab{opacity:1;transform:translateX(-56px) scale(1);pointer-events:auto}.langFab{width:46px;height:46px;min-width:0;padding:0;border-radius:50%;background:rgba(37,99,235,.58);color:#eef;border-color:rgba(92,200,255,.68);font-size:23px;font-weight:900;line-height:1;box-shadow:0 8px 22px rgba(0,0,0,.22);backdrop-filter:blur(4px)}.langFab:hover,.langFab:focus-visible{background:#3b82f6;border-color:#5cc8ff;box-shadow:0 12px 32px rgba(0,0,0,.35)}.fabActions .helpFab{width:46px;height:46px;min-width:0;padding:0;border-radius:50%;background:rgba(92,200,255,.62);color:#061019;border-color:rgba(92,200,255,.72);font-size:24px;font-weight:900;line-height:1;box-shadow:0 8px 22px rgba(0,0,0,.22);backdrop-filter:blur(4px)}.fabActions .helpFab:hover,.fabActions .helpFab:focus-visible{background:#8bdcff;border-color:#8bdcff;box-shadow:0 12px 32px rgba(0,0,0,.35)}.langMenu{position:fixed;right:72px;bottom:74px;display:none;min-width:132px;background:#111820;border:1px solid #5cc8ff;border-radius:12px;padding:6px;z-index:17;box-shadow:0 12px 32px rgba(0,0,0,.35)}.langMenu.show{display:block}.langMenu button{display:block;width:100%;min-width:0;text-align:left;margin:2px 0;padding:7px 10px}.langMenu button.active{background:#5cc8ff;color:#061019;font-weight:800}.reconnectOverlay{position:fixed;inset:0;background:rgba(16,19,24,.88);display:none;align-items:center;justify-content:center;z-index:100}.reconnectOverlay.show{display:flex}.reconnectBox{text-align:center;color:#e8edf2}.reconnectSpinner{width:48px;height:48px;border:4px solid #2b3441;border-top-color:#5cc8ff;border-radius:50%;animation:spin 1s linear infinite;margin:0 auto 16px}.reconnectText{font-size:16px;line-height:1.6}@keyframes spin{to{transform:rotate(360deg)}}.staCols{display:grid;grid-template-columns:1.2fr 1fr;gap:14px;align-items:start}#wifiStaModal .dialog{width:min(640px,calc(100vw - 28px))}@media(max-width:640px){.staCols{grid-template-columns:1fr}}.histRow{display:flex;align-items:center;gap:8px;width:100%;text-align:left;margin-top:4px;padding:6px 8px;background:#111820;border:1px solid #2b3441;border-radius:6px;color:#e8edf2}.histRank{flex:none;display:inline-flex;align-items:center;justify-content:center;min-width:24px;height:18px;padding:0 5px;border-radius:999px;background:#5cc8ff;color:#061019;font-size:11px;font-weight:800}.histSsid{flex:1;min-width:0;overflow:hidden;white-space:nowrap;font-size:13px}.histDel{flex:none;min-width:0;width:26px;height:26px;padding:0;border-radius:6px;display:inline-flex;align-items:center;justify-content:center;background:transparent;border-color:#2b3441;color:#8fa1b5;font-size:13px}.histDel:hover{color:#ff6b6b;border-color:#ff6b6b}.skinSwitch{display:inline-flex;align-items:center;gap:2px;background:#171c24;border:1px solid #2b3441;border-radius:999px;padding:1px;margin-left:auto}
.headerRow .otaLink{margin-left:0;display:flex;align-items:center}.skinSwitch .skinSeg{padding:0 10px;height:20px;min-width:0;border:1px solid transparent;border-radius:999px;background:transparent;color:#8fa1b5;font-size:11px;font-weight:800;line-height:1}.skinSwitch .skinSeg:hover{background:#222b36;color:#e8f6ff}.skinSwitch .skinSeg.active{background:#5cc8ff;border-color:#5cc8ff;color:#061019}
.skinSwitch .skinSeg.active:hover{background:#8bdcff;color:#061019}
</style>
<style id="donkeySkin">
body.donkey-skin{font-family:ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,sans-serif;background:#09090b;color:#f4f4f5}
body.donkey-skin .version,body.donkey-skin .toggleLabel,body.donkey-skin .stateHead,body.donkey-skin .stateMeta b,body.donkey-skin .statusRow b,body.donkey-skin .formRow label,body.donkey-skin .scanMeta,body.donkey-skin .muted,body.donkey-skin .recMeta,body.donkey-skin .rcCell b{color:#a1a1aa}
body.donkey-skin .statusRow span,body.donkey-skin .recMeta b,body.donkey-skin .reconnectBox{color:#f4f4f5}
body.donkey-skin #status,body.donkey-skin .stateSub,body.donkey-skin .dialog p{color:#d4d4d8}
body.donkey-skin .panel{background:#18181b;border-color:#27272a}
body.donkey-skin .stateCard{background:#18181b;border-color:#27272a;border-radius:8px}
body.donkey-skin .foldHead{background:#18181b;border-color:#27272a;color:#e4e4e7}
body.donkey-skin .foldHead:hover{background:#27272a}
body.donkey-skin .rcCell{background:#09090b;border-color:#27272a}
body.donkey-skin .helpModal,body.donkey-skin .dialog{background:#18181b;border-color:#27272a;border-radius:8px}
body.donkey-skin .langMenu,body.donkey-skin .scanPopover,body.donkey-skin .devHint:hover:after,body.donkey-skin .copyValue:hover:after,body.donkey-skin .histRow{background:#18181b;border-color:#27272a;border-radius:8px}
body.donkey-skin .toast{background:#18181b;border-radius:8px}
body.donkey-skin canvas{background:#09090b;border-color:#27272a}
body.donkey-skin #chartPanel:fullscreen{background:#09090b}
body.donkey-skin .log{background:#09090b}
body.donkey-skin .modal{background:rgba(9,9,11,.72)}
body.donkey-skin .helpOverlay{background:rgba(9,9,11,.45)}
body.donkey-skin .reconnectOverlay{background:rgba(9,9,11,.88)}
body.donkey-skin input,body.donkey-skin select,body.donkey-skin #cmdTarget{background:#09090b;border-color:#3f3f46;color:#f4f4f5}
body.donkey-skin button{background:#0891b2;border-color:#0891b2;color:#fff;border-radius:6px}
body.donkey-skin button:hover{background:#0e7490;border-color:#0e7490}
body.donkey-skin .iconButton,body.donkey-skin .gear,body.donkey-skin .helpClose{background:#27272a;border-color:#3f3f46;color:#f4f4f5}
body.donkey-skin .iconButton:hover,body.donkey-skin .gear:hover,body.donkey-skin .helpClose:hover{background:#3f3f46;border-color:#52525b}
body.donkey-skin .otaButton{background:#0891b2;border-color:#0891b2;color:#fff;border-radius:6px}
body.donkey-skin .otaButton:hover{background:#0e7490}
body.donkey-skin .netTabs button{background:#27272a;border-color:#3f3f46;color:#a1a1aa;border-radius:6px}
body.donkey-skin .netTabs button.active{background:#0891b2;border-color:#0891b2;color:#fff}
body.donkey-skin .langMenu button{background:#27272a;color:#f4f4f5}
body.donkey-skin .langMenu button.active{background:#0891b2;color:#fff}
body.donkey-skin .histRow{background:#18181b;border-color:#27272a;color:#f4f4f5}
body.donkey-skin .histDel{background:transparent;border-color:#27272a;color:#a1a1aa}
body.donkey-skin .scanRow{background:#27272a;color:#f4f4f5}
body.donkey-skin .slider{background:#52525b}
body.donkey-skin .toggleSwitch input:checked+.slider{background:#0891b2}
body.donkey-skin .mode2{border-color:#22d3ee}
body.donkey-skin .mode2 .stateDot{background:#22d3ee}
body.donkey-skin .copyValue:hover{color:#22d3ee}
body.donkey-skin .foldIcon{color:#22d3ee}
body.donkey-skin .histRank{background:#22d3ee;color:#083344}
body.donkey-skin .reconnectSpinner{border-color:#27272a;border-top-color:#22d3ee}
body.donkey-skin .driftBar{background:#27272a}
body.donkey-skin .stateDot{background:#52525b}
body.donkey-skin .fabToggle{border-radius:50%;background:#67e8f9;border-color:#67e8f9;box-shadow:0 0 18px #22d3ee,0 0 36px rgba(34,211,238,.55)}
body.donkey-skin .fabToggle:hover,body.donkey-skin .fabToggle:focus-visible,body.donkey-skin .fabToggle:active{border-radius:50%;background:#67e8f9;border-color:#67e8f9;box-shadow:0 0 22px #67e8f9,0 0 44px rgba(103,232,249,.72)}
body.donkey-skin .langFab{background:rgba(8,145,178,.62);border-color:rgba(34,211,238,.68)}
body.donkey-skin .langFab:hover,body.donkey-skin .langFab:focus-visible{background:#0891b2;border-color:#22d3ee}
body.donkey-skin .fabActions .helpFab{background:rgba(34,211,238,.62);color:#083344;border-color:rgba(34,211,238,.72)}
body.donkey-skin .fabActions .helpFab:hover,body.donkey-skin .fabActions .helpFab:focus-visible{background:#67e8f9;border-color:#67e8f9}
body.donkey-skin .skinSwitch{background:#18181b;border-color:#27272a}
body.donkey-skin .skinSeg{color:#a1a1aa}
body.donkey-skin .skinSeg:hover{background:#27272a;color:#f4f4f5}
body.donkey-skin .skinSeg.active{background:#0891b2;border-color:#0891b2;color:#fff}
body.donkey-skin .skinSeg.active:hover{background:#0e7490;color:#fff}
</style>
</head>
<body>
...
<div id="driftCard" class="stateCard"><a href="/drift" style="position:absolute;right:8px;top:6px;font-size:11px;color:#5cc8ff;text-decoration:none;z-index:2">Tune</a><div class="stateHead" data-i18n="state.drift">Drift</div><div class="stateValue" id="driftValue">--</div><div class="stateSub" id="driftSub">waiting</div><div class="driftBar"><i id="driftNeedle"></i></div><span class="stateDot"></span></div>
...
<div class="chartFooter"><div class="chartToolbar"><button class="iconButton" onclick="toggleChart()" id="chartBtn" title="暂停"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/></svg></button><button class="iconButton" onclick="clearChart()" title="清空"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg></button><button class="iconButton" onclick="toggleTub()" id="tubRecordBtn" title="开始录制"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="8"/></svg></button><button class="iconButton" onclick="td()" id="tubDownloadBtn" title="下载 Tub JSON"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg></button><span class="recMeta">录制量<b id="tubMeta">0</b></span></div><div class="legend"><span class="c1">Throttle<b id="thrMeta">--</b></span><span class="c2">Steering<b id="strMeta">--</b></span><span class="c4">GyroZ<b id="gzMeta">--</b></span></div></div>
</section>
<section class="panel" id="serialPanel">
<div class="row"><button class="iconButton" onclick="togglePause()" id="pauseBtn" title="暂停"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/></svg></button><button class="iconButton" onclick="clearLog()" title="清空"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg></button><button class="iconButton" onclick="sendCmd()" id="sendBtn" title="发送"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M2 21l21-9L2 3v7l15 2-15 2v7z"/></svg></button><input id="cmd"><select id="cmdTarget"><option value="web">Web</option></select></div>
<div id="log" class="log"></div>
</section>
<section class="panel wide" id="diagnosticsPanel">
<div id="rcFold" class="fold"><button class="foldHead" onclick="toggleFold('rcFold')" aria-expanded="false"><span class="foldIcon">▸</span><span data-i18n="panel.rcChannels">RC Channels</span></button><div class="foldBody"><div class="rcGrid"><div class="rcCell"><b>CH1 Steering</b><span id="ch1Value">----</span></div><div class="rcCell"><b>CH2 Throttle</b><span id="ch2Value">----</span></div><div class="rcCell"><b>CH3 Park</b><span id="ch3Value">----</span></div><div class="rcCell modeCh"><b>CH4 Mode</b><span id="ch4Value">----</span></div><div class="rcCell"><b>CH5 Drift</b><span id="ch5Value">----</span></div><div class="rcCell"><b>CH6 Scale</b><span id="ch6Value">----</span></div></div><div style="display:flex;gap:6px;margin-top:6px"><div class="rcCell" style="flex:1"><b>OUT Steering</b><span id="servoDutyValue">----</span></div><div class="rcCell" style="flex:1"><b>OUT Throttle</b><span id="escDutyValue">----</span></div></div><div style="display:flex;gap:6px;margin-top:6px"><div class="rcCell" style="flex:1"><b>Mid S</b><span id="servoMidValue">----</span><button onclick="setServoMid()" style="font-size:11px;padding:1px 6px;margin-left:4px;cursor:pointer" title="设为转向中点">Set</button></div><div class="rcCell" style="flex:1"><b>Mid T</b><span id="motorMidValue">----</span><button onclick="setMotorMid()" style="font-size:11px;padding:1px 6px;margin-left:4px;cursor:pointer" title="设为油门中点">Set</button></div></div><div style="display:flex;gap:6px;margin-top:6px"><div class="rcCell" style="flex:1"><b>Min T</b><input type="range" id="throttleMinSlider" min="4915" max="7372" value="4915" step="1" oninput="setThrottleMin(this.value)" style="width:100%;height:18px;margin:2px 0"><span id="throttleMinValue">----</span></div><div class="rcCell" style="flex:1"><b>Max T</b><input type="range" id="throttleMaxSlider" min="7372" max="9830" value="9830" step="1" oninput="setThrottleMax(this.value)" style="width:100%;height:18px;margin:2px 0"><span id="throttleMaxValue">----</span></div></div></div></div></div>
<div style="margin:10px 0"><button onclick="openJoystickCalModal()" data-i18n="button.joystickCal">Calibrate Joystick</button><button onclick="window.open('http://192.168.3.150/drift','_blank')" data-i18n="button.driftSettings" style="margin-left:8px">漂移设置</button></div>
<div id="joystickCalStatus" style="font-size:12px;color:#8fa1b5;margin-bottom:8px">Steering: -- / -- / -- | Throttle: -- / -- / --</div>
...
<button id="fabToggle" class="fabToggle" onclick="toggleFabActions(event)" aria-label="快捷入口"></button>
<div id="fabActions" class="fabActions"><button id="langFab" class="langFab" onclick="toggleLanguageMenu(event)" aria-label="语言" data-i18n-aria="language.title">🌐</button><button id="helpFab" class="helpFab" onclick="openHelpModal()" aria-label="功能说明" data-i18n-aria="help.title">?</button></div>
...
const I18N={zh:{'app.title':'Drifter Console','language.title':'语言','button.ota':'OTA','button.pause':'暂停','button.resume':'继续','button.draw':'绘制','button.clear':'清空','button.fullscreen':'全屏','button.split':'分屏','button.send':'发送','button.tubRecord':'开始录制','button.tubStopRecord':'停止录制','button.tubDownload':'下载 Tub JSON','button.cancel':'取消','button.confirmDev':'确认开启','button.connect':'连接','button.ok':'知道了','button.reconfigure':'重新配置','button.copyIp':'复制 IP','button.copyUrl':'复制地址','button.openNewUrl':'打开新地址','wifi.saveRestartAp':'保存并重启 AP','state.mode':'Mode','state.park':'Park','state.drift':'Drift','state.voltage':'Voltage','state.network':'Network','state.remain':'REMAIN','state.ssid':'SSID','panel.rcChannels':'RC Channels','panel.statusDetails':'STATUS Details','dev.title':'开启开发模式？','dev.body':'开发模式会持久化，并允许 Web Console 免认证保持 OTA 监听。不会放宽控制命令；实际 OTA 传输期间固件会默认 Park Locked。','wifi.apTitle':'AP 名称配置','wifi.apPrefixLabel':'前缀','wifi.apPlaceholder':'如 MUS4','wifi.apNotice':'前缀仅限大小写字母和数字，不超过6位；后缀固定为“-ESP”。保存后会重启 AP，当前浏览器连接会短暂断开。','wifi.staTitle':'STA Wi-Fi 配置','wifi.staPlaceholder':'STA SSID','wifi.passwordLabel':'密码','wifi.passwordPlaceholder':'Wi-Fi 密码，留空表示开放网络','wifi.scanning':'扫描中...','wifi.staNotice':'注意只能连接2.4G WiFi','wifi.hidePassword':'隐藏密码','wifi.showPassword':'显示密码','wifi.failureTitle':'STA 连接失败','wifi.handoffTitle':'STA 切换提示','help.title':'功能说明','help.close':'关闭功能说明','help.statusCards':'状态卡片：查看模式、Park、OTA、连接状态','help.network':'Network：查看 AP/STA IP，配置 Wi-Fi','help.diagnostics':'Diagnostics：运行测试、回归、维护命令','help.serialLog':'Serial Log：查看设备日志','help.tubJson':'Tub JSON：记录并下载遥测样本','help.otaDev':'OTA / DEV：固件更新与开发模式开关','mode.manual':'Manual input','mode.assist':'Pilot steering','mode.auto':'Pilot control','mode.unknown':'unknown','park.guarded':'output guarded','park.enabled':'drive enabled','battery':'battery','voltage.disconnected':'未连接','toast.copyFailed':'复制失败，请手动选择 IP','toast.copiedIp':'已复制 IP：','toast.copiedUrl':'已复制地址：','toast.newIpUnavailable':'新 IP 暂不可用，请先连接设备 AP 查看','toast.newUrlUnavailable':'新地址暂不可用，请连接设备 AP 查看','error.parkRequired':'当前操作需要 Park Locked。请将 CH3/Park 切到锁定状态后重试。','error.authRequired':'当前操作需要授权。请先 AUTH，或开启 DEV MODE 后重试。'},en:{'app.title':'Drifter Console','language.title':'Language','button.ota':'OTA','button.pause':'Pause','button.resume':'Resume','button.draw':'Draw','button.clear':'Clear','button.fullscreen':'Fullscreen','button.split':'Split','button.send':'Send','button.tubRecord':'Start Recording','button.tubStopRecord':'Stop Recording','button.tubDownload':'Download Tub JSON','button.cancel':'Cancel','button.confirmDev':'Enable','button.connect':'Connect','button.ok':'OK','button.reconfigure':'Reconfigure','button.copyIp':'Copy IP','button.copyUrl':'Copy URL','button.openNewUrl':'Open new URL','wifi.saveRestartAp':'Save and restart AP','state.mode':'Mode','state.park':'Park','state.drift':'Drift','state.voltage':'Voltage','state.network':'Network','state.remain':'REMAIN','state.ssid':'SSID','panel.rcChannels':'RC Channels','panel.statusDetails':'STATUS Details','dev.title':'Enable dev mode?','dev.body':'Dev mode is persistent and lets Web Console keep OTA listening without AUTH. It does not loosen control commands; firmware still defaults to Park Locked during OTA transfer.','wifi.apTitle':'AP Name Configuration','wifi.apPrefixLabel':'Prefix','wifi.apPlaceholder':'e.g. MUS4','wifi.apNotice':'Prefix is limited to letters and digits (max 6 chars). Suffix "-ESP" is fixed. Saving restarts AP and briefly disconnects this browser.','wifi.staTitle':'STA Wi-Fi settings','wifi.staPlaceholder':'STA SSID','wifi.passwordLabel':'Password','wifi.passwordPlaceholder':'Wi-Fi password, leave blank for open network','wifi.scanning':'Scanning...','wifi.staNotice':'Only 2.4 GHz Wi-Fi is supported','wifi.hidePassword':'Hide password','wifi.showPassword':'Show password','wifi.failureTitle':'STA connection failed','wifi.handoffTitle':'STA handoff notice','help.title':'Help','help.close':'Close help','help.statusCards':'Status Cards: view mode, Park, OTA, and connection status','help.network':'Network: view AP/STA IP and configure Wi-Fi','help.diagnostics':'Diagnostics: run tests, regression, and maintenance commands','help.serialLog':'Serial Log: view device logs','help.tubJson':'Tub JSON: record and download telemetry samples','help.otaDev':'OTA / DEV: firmware update and development mode switches','mode.manual':'Manual input','mode.assist':'Pilot steering','mode.auto':'Pilot control','mode.unknown':'unknown','park.guarded':'output guarded','park.enabled':'drive enabled','battery':'battery','voltage.disconnected':'Not connected','toast.copyFailed':'Copy failed, select the IP manually','toast.copiedIp':'Copied IP: ','toast.copiedUrl':'Copied URL: ','toast.newIpUnavailable':'New IP is not available yet; connect to device AP first','toast.newUrlUnavailable':'New URL is not available yet; connect to device AP first','error.parkRequired':'This action requires Park Locked. Switch CH3/Park to locked and retry.','error.authRequired':'This action requires authorization. Send AUTH first, or enable DEV MODE and retry.'}};
...
function collapseFabActions(){fabActions.classList.remove('show');closeLanguageMenu()}
function toggleLanguageMenu(e){if(e)e.stopPropagation();fabActions.classList.add('show');langMenu.classList.toggle('show')}
...
async function refreshJoystickCalStatus(){try{const r=await fetch('/api/joystick-cal');const text=await r.text();const s=parseJoystickCalStatus(text);if(s){joystickCalStatus.textContent=`${t('cal.label.steering')}: ${formatCalAxis(s.steer_en,s.steer_min,s.steer_mid,s.steer_max)} | ${t('cal.label.throttle')}: ${formatCalAxis(s.throt_en,s.throt_min,s.throt_mid,s.throt_max)}`;renderCalStep(s.state);}else{joystickCalStatus.textContent=`${t('cal.label.steering')}: -- / -- / -- | ${t('cal.label.throttle')}: -- / -- / --`;}}catch(e){joystickCalStatus.textContent=`${t('cal.label.steering')}: -- / -- / -- | ${t('cal.label.throttle')}: -- / -- / --`;}}
function renderCalStep(state){joystickCalActionBtn.style.display=state===0?'inline-block':'none';joystickCalRetryBtn.style.display=(state===2||state===3)?'inline-block':'none';joystickCalSaveBtn.style.display=state===3?'inline-block':'none';if(state===0){joystickCalStepText.textContent=t('cal.step.center');joystickCalActionBtn.textContent=t('cal.action.start');}else if(state===1){joystickCalStepText.textContent=t('cal.step.center');}else if(state===2){joystickCalStepText.textContent=t('cal.step.minmax');}else if(state===3){joystickCalStepText.textContent=t('cal.step.done');joystickCalRetryBtn.textContent=t('cal.action.retry');joystickCalSaveBtn.textContent=t('cal.action.save');}joystickCalLive.textContent='';}
...
function clearChart(){pointHead=0;pointCount=0;points.fill(null);scrollOffset=0;smoothedDt=16;gridReady=false;tubSamples=[];tubStartedMs=0;tubStoppedMs=0;tubLastSeq=0;tubRecording=false;updateTubMeta();draw()}function enterScreenSaver(){screenSaverActive=true;screenSaverStartTime=performance.now();saverTime=0}function exitScreenSaver(){screenSaverActive=false;screenSaverStartTime=0;parkLockedAt=0;ch1Samples=[];clearChart()}
...
function tp(p){if(!tubRecording||!p||p.ch6===undefined)return;const s=Number(p.seq||0);if(s&&s===tubLastSeq)return;if(!tubSamples.length)tubStartedMs=Number(p.t||0);tubSamples.push(p);tubLastSeq=s;tubStoppedMs=Number(p.t||tubStoppedMs);updateTubMeta();if(tubSamples.length>=TUB_MAX_SAMPLES)te()}
...
function updateNetworkCard(s){updateNetworkCard.last=s;const ap=s.ap_ip||'--',sta=s.sta_ip||'0.0.0.0',apSsid=s.ap_ssid||'MUS4-ESP',staSsid=s.sta_ssid||'--',hostIp=s.host_ip||'',configured=s.sta_configured==='1',staConnected=s.sta_connected==='1',selected=networkTabPinned?networkTab:(staConnected?'sta':'ap');networkApTab.classList.toggle('active',selected==='ap');networkStaTab.classList.toggle('active',selected==='sta');networkHostTab.classList.toggle('active',selected==='host');if(selected==='host'){networkCopyIp=hostIp;networkValue.textContent=hostIp||'--';networkSsidValue.textContent='Serial2';networkCard.className='stateCard '+(hostIp?'mode0':'driftOff')}else if(selected==='ap'){networkCopyIp=ap;networkValue.textContent=ap;networkSsidValue.textContent=apSsid;networkCard.className='stateCard mode0'}else{networkCopyIp=configured?sta:'';networkValue.textContent=configured?sta:'disabled';networkSsidValue.textContent=configured?staSsid:'--';networkCard.className='stateCard '+(staConnected?'mode0':'driftOff')}if(staConnected&&sta&&sta!=='0.0.0.0'&&sta!=='--'&&configured&&window.handoffShownForStaIp!==sta){line('[sta-debug] updateNetworkCard sees STA IP, show handoff');window.handoffShownForStaIp=sta;showWifiStaHandoffModal({ssid:staSsid,sta_ip:sta,handoff_ap_ssid:apSsid})}if(s.version){versionLabel.textContent=s.version.replace(/^V/,'v')}}
...
function updateApPreview(){apSsid.value=apSsid.value.replace(/[^A-Za-z0-9]/g,'');const p=apSsid.value.trim();apPreview.textContent=p?'完整 SSID: '+p+'-ESP':''}async function openWifiApModal(){apNotice.textContent=t('wifi.apNotice');apSaveBtn.disabled=false;apSaveBtn.textContent=t('wifi.saveRestartAp');await refreshWifiAp();const s=apSsid.value;if(s&&s.endsWith('-ESP'))apSsid.value=s.slice(0,-4);updateApPreview();wifiApModal.classList.add('show')}
function closeWifiApModal(){if(apSaving)return;wifiApModal.classList.remove('show')}
async function saveWifiAp(){if(apSaving)return;const v=apSsid.value.trim();if(!v||!/^([A-Za-z0-9]{1,6})$/.test(v)){apNotice.textContent='前缀只能使用大小写字母和数字，长度为 1-6 位。';return}try{apSaving=true;apSaveBtn.disabled=true;apSaveBtn.textContent='正在保存...';apNotice.textContent='正在保存';const body=new URLSearchParams();body.set('ssid',v);const r=await fetch('/api/wifi-ap',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body});if(!r.ok){const t=await r.text();showCommandError(t);if(t.includes('invalid_ssid'))apNotice.textContent='前缀只能使用大小写字母和数字，长度为 1-6 位。';else apNotice.textContent='保存失败';throw new Error(t)}showToast('AP 名称已保存，正在重启 AP',true);wifiApModal.classList.remove('show');refreshStatus()}catch(e){line('wifi ap save error: '+e)}finally{apSaving=false;apSaveBtn.disabled=false;apSaveBtn.textContent='保存并重启 AP'}}
...
function selectWifiSsid(ssid,channel){staSelectedChannel=Number(channel)||0;staSsid.value=ssid;staPassword.value='';staPasswordPlaceholder=false;staPasswordDirty=false;staPasswordVisible=false;staSavedPassword='';staSavedPasswordKnown=false;updateStaPasswordEye();closeWifiScanPopover();staPassword.focus()}
...
async function openWifiStaModal(){closeWifiScanPopover();staNotice.textContent='注意只能连接2.4G WiFi';document.getElementById('hostWifiToggle').checked=false;onHostWifiToggle();await refreshWifiSta(true);wifiStaModal.classList.add('show');refreshWifiHistory()}
...
function closeWifiStaHandoffModal(){wifiStaHandoffModal.classList.remove('show');wifiStaModal.classList.remove('show')}
function handoffStaUrl(j){const ip=(j&&j.sta_ip)||(j&&j.handoff_sta_ip)||'';return ip&&ip!=='0.0.0.0'?'http://'+ip+'/':''}
function showWifiStaHandoffModal(j){const target=(j&&j.ssid)||(j&&j.handoff_target_ssid)||staSsid.value.trim()||'--',ap=(j&&j.handoff_ap_ssid)||'--',url=handoffStaUrl(j),ip=url.replace(/^http:\/\//,'').replace(/\/$/,''),connecting=!!(j&&j.connecting);if(!connecting&&ip){if(window.handoffShownForStaIp===ip)return;window.handoffShownForStaIp=ip}wifiStaHandoffText.textContent=(connecting?'设备正在连接 Wi-Fi：':'请将电脑/手机切换到 Wi-Fi：')+target+'\n局域网 IP：'+(ip||'等待设备获取新 IP')+'\n访问地址：'+(url||'等待设备获取新 IP')+'\n连上后设备会把 Wi-Fi 名临时改成 MUS4-<设备IP> 并广播约 60 秒，请在电脑/手机的 Wi-Fi 列表中找到该网络读出设备 IP；若设备未连上会自动恢复 AP（'+ap+'）用于重配。';wifiStaHandoffModal.classList.add('show')}
...
async function redirectToStaConsole(ip){const url='http://'+ip+'/';staNotice.textContent='STA 已连接，IP：'+ip+'，请切换到该 Wi-Fi 后打开 '+url;showToast('STA 已连接：'+url,true);return true}
async function waitWifiStaConnectionResult(){const deadline=Date.now()+60000;let ipDeadline=0;line('[sta-debug] waitWifiStaConnectionResult start');while(Date.now()<deadline){let j=null;try{j=await refreshWifiSta(false)}catch(e){j=null;line('[sta-debug] refreshWifiSta exception: '+e)}if(!j){line('[sta-debug] poll null, retry');await new Promise(resolve=>setTimeout(resolve,800));continue}line('[sta-debug] poll connected='+j.connected+' ip='+j.sta_ip+' handoff='+j.handoff_active+' error='+j.last_error+' timed_out='+j.timed_out);if(j&&j.connected){if(!j.sta_ip||j.sta_ip==='0.0.0.0'){if(ipDeadline===0)ipDeadline=Date.now()+5000;if(Date.now()<ipDeadline){staNotice.textContent='STA 已连接，正在获取 IP...';showWifiStaHandoffModal({...j,connecting:true});await new Promise(resolve=>setTimeout(resolve,800));continue}}staNotice.textContent='STA 已连接\n局域网 IP：'+j.sta_ip+'\n访问地址：http://'+j.sta_ip+'/';await refreshStatus();cmd.value='';if(j.sta_ip&&j.sta_ip!=='0.0.0.0'){line('[sta-debug] showing handoff modal');window.handoffShownForStaIp=j.sta_ip;showWifiStaHandoffModal(j);showToast('STA 已连接：'+handoffStaUrl(j),true)}else if(j.handoff_active){line('[sta-debug] showing handoff modal (handoff_active)');showWifiStaHandoffModal(j)}else{line('[sta-debug] connected but no handoff condition met')}return true}if(j&&(j.last_error||j.timed_out)){window.handoffShownForStaIp='';staNotice.textContent='连接失败';line('[sta-debug] failure: '+j.last_error+' / '+j.last_error_message);showWifiStaFailureModal(j);return false}showWifiStaHandoffModal({...j,connecting:true});await new Promise(resolve=>setTimeout(resolve,800))}window.handoffShownForStaIp='';staNotice.textContent='连接失败';line('[sta-debug] timeout');showWifiStaFailureModal({ssid:staSsid.value.trim(),last_error_message:'STA 连接超时，请检查 SSID、密码与路由器信号。'});return false}
function onHostWifiToggle(){const hw=document.getElementById('hostWifiToggle').checked,bar=document.getElementById('hostWifiStatusBar'),clearBtn=document.getElementById('staClearBtn'),connectBtn=document.getElementById('staConnectBtn'),notice=document.getElementById('staNotice');if(hw){clearBtn.style.display='none';connectBtn.textContent='发送到上位机';connectBtn.onclick=saveHostWifi;notice.textContent='通过串口将 WiFi 凭据发送给 Linux 上位机，由上位机执行 nmcli 连接';bar.style.display='block'}else{clearBtn.style.display='';connectBtn.textContent='连接';connectBtn.onclick=saveWifiSta;notice.textContent='注意只能连接2.4G WiFi';bar.style.display='none';stopHostWifiPoll()}}
...
async function pollHostWifiStatus(){try{const r=await fetch('/api/host-wifi-status');const j=await r.json();document.getElementById('hostWifiStatusLabel').textContent={IDLE:'等待...',connecting:'正在连接上位机 WiFi...',connected:'上位机配网成功!',failed:'上位机配网失败'}[j.status]||j.status;const ipEl=document.getElementById('hostWifiStatusIp'),errEl=document.getElementById('hostWifiStatusError');if(j.status==='connected'){ipEl.style.display='';ipEl.textContent='IP: '+j.ip;errEl.style.display='none';stopHostWifiPoll();showToast('上位机配网成功: '+j.ip,true)}else if(j.status==='failed'){errEl.style.display='';errEl.textContent='失败: '+j.error;ipEl.style.display='none';stopHostWifiPoll()}else{ipEl.style.display='none';errEl.style.display='none'}}catch(e){}};
async function saveHostWifi(){const ssid=staSsid.value.trim(),pwd=staPassword.value;if(!ssid){alert('SSID 不能为空');return}closeWifiScanPopover();document.getElementById('hostWifiStatusBar').style.display='block';document.getElementById('hostWifiStatusLabel').textContent='正在发送配网指令...';const cmd='WIFI|'+ssid+'|'+pwd;try{const r=await fetch('/api/cmd?target=serial',{method:'POST',headers:{'Content-Type':'text/plain'},body:cmd});if(r.ok){document.getElementById('hostWifiStatusLabel').textContent='等待上位机响应...';stopHostWifiPoll();hostWifiPollTimer=setInterval(pollHostWifiStatus,2000)}else{const t=await r.text();document.getElementById('hostWifiStatusLabel').textContent='发送失败';document.getElementById('hostWifiStatusError').textContent=t;document.getElementById('hostWifiStatusError').style.display=''}}catch(e){document.getElementById('hostWifiStatusLabel').textContent='发送失败';document.getElementById('hostWifiStatusError').textContent=e.message||'网络错误';document.getElementById('hostWifiStatusError').style.display=''}}
async function saveWifiSta(){try{closeWifiScanPopover();staNotice.textContent='设备正在连接 Wi-Fi。连上后请在电脑/手机的 Wi-Fi 列表中查看名为 MUS4-<设备IP> 的网络（约 60 秒后该 AP 自动关闭）';line('[sta-debug] saveWifiSta start ssid='+staSsid.value.trim());const body=new URLSearchParams();body.set('ssid',staSsid.value.trim());body.set('source',wifiStaSaveSource());if(staSelectedChannel>=1&&staSelectedChannel<=14)body.set('channel',String(staSelectedChannel));if(!staPasswordDirty&&(staPasswordPlaceholder||staSavedPasswordKnown))body.set('keep_password','1');else body.set('password',staPassword.value);const r=await fetch('/api/wifi-sta',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body});if(!r.ok){const t=await r.text();staNotice.textContent='连接失败';showWifiStaFailureModal({ssid:staSsid.value.trim(),last_error_message:t});throw new Error(t)}const saved=await r.json().catch(()=>null);line('[sta-debug] saved response handoff_active='+(saved&&saved.state&&saved.state.handoff_active));showWifiStaHandoffModal({...(saved&&saved.state||{}),connecting:true});staPassword.value='';staPasswordPlaceholder=false;staPasswordDirty=false;staPasswordVisible=false;staSavedPassword='';staSavedPasswordKnown=false;updateStaPasswordEye();await refreshWifiSta(true);refreshStatus();await waitWifiStaConnectionResult()}catch(e){line('wifi sta save error: '+e)}}
...
staSsid.addEventListener('input',()=>{staSelectedChannel=0});
...
.tuneSection{margin-top:14px;padding-top:14px;border-top:1px solid #243041}
.sectionTitle{font-size:13px;font-weight:700;color:#d6deea}
.sectionDesc{font-size:12px;color:#8fa1b5;margin-top:4px}
.summaryGrid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}
.summaryItem{background:#111820;border:1px solid #2b3441;border-radius:10px;padding:10px 12px}
.summaryItem .k{font-size:11px;color:#8fa1b5}
.summaryItem .v{font-size:18px;font-weight:700;margin-top:4px}
.field{display:flex;flex-direction:column;gap:6px;font-size:12px;color:#8fa1b5;background:#111820;border:1px solid #2b3441;border-radius:10px;padding:10px 12px}
.fieldTitle{font-size:12px;color:#d6deea;font-weight:700}
.fieldHint{font-size:11px;color:#8fa1b5;line-height:1.35;min-height:28px}
...
<div id="weakestTrendReason" class="scoreExplain">拖分原因：拖分分析中，继续保持当前动作。</div>
...
<div class="muted">基础阈值管判定边界，评分参数管评分手感</div>
</div>
<div id="judgeConfigCurrent" class="muted">读取设备配置中...</div>
</div>
<div id="judgeConfigSummary" class="summaryGrid" style="margin-top:12px">
<div class="summaryItem"><div class="k">碰撞阈值</div><div class="v">--</div></div>
<div class="summaryItem"><div class="k">大弯阈值</div><div class="v">--</div></div>
<div class="summaryItem"><div class="k">窗口大小</div><div class="v">--</div></div>
<div class="summaryItem"><div class="k">碰撞扣分</div><div class="v">--</div></div>
</div>
<div class="tuneSection">
<div class="sectionTitle">基础阈值</div>
<div class="sectionDesc">先调判定边界，再看评分手感。</div>
<div class="tuneGrid" style="margin-top:12px">
<label class="field"><span class="fieldTitle">碰撞阈值</span><span class="fieldHint">越小越容易触发碰撞。</span><input id="collisionThresholdInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">大弯阈值</span><span class="fieldHint">越小越容易进入大弯区。</span><input id="bigTurnThresholdInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">窗口大小</span><span class="fieldHint">越大越平滑，但响应更慢。</span><input id="windowSizeInput" type="number" step="1"></label>
</div>
...
<div class="tuneSection">
<div class="sectionTitle">评分参数</div>
<div class="sectionDesc">这一组控制评分灵敏度，数值越大通常越敏感。</div>
<div class="tuneGrid" style="margin-top:12px">
<label class="field"><span class="fieldTitle">碰撞扣分</span><span class="fieldHint">每次碰撞扣多少分。</span><input id="collisionPenaltyInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">转弯平滑敏感度</span><span class="fieldHint">越大越容易因为抖动掉分。</span><input id="turnSmoothnessWeightInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">区间匹配敏感度</span><span class="fieldHint">越大越容易因为动作不协调掉分。</span><input id="rangeMatchWeightInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">陀螺稳定敏感度</span><span class="fieldHint">越大越容易因为陀螺波动掉分。</span><input id="gyroStabilityWeightInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">大弯稳定敏感度</span><span class="fieldHint">越大越容易因为大弯阶段不稳掉分。</span><input id="bigTurnStabilityWeightInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">速度稳定敏感度</span><span class="fieldHint">越大越容易因为 pseudoSpeed 波动掉分。</span><input id="speedStabilityWeightInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">油门稳定敏感度</span><span class="fieldHint">越大越容易因为抽油门掉分。</span><input id="throttleStabilityWeightInput" type="number" step="0.1"></label>
</div>
</div>
</div>
<div class="panel">
...
function createScoreState(){
  return{
    ...
    lowestDimension:'--',
    weakestTrend:'分析中',
    weakestTrendReason:'拖分分析中，继续保持当前动作。',
    gyroHistory:[],
    pseudoHistory:[],
    throttleHistory:[],
    lastGyroZ:null,
...
function getWeakestTrendReason(name){
  if(name==='转弯平滑')return'转弯平滑：最近 gyroZ 变化偏猛，建议下调转弯平滑敏感度。';
  if(name==='区间匹配')return'区间匹配：最近 pseudoSpeed 与转向强度配合不够协调，建议下调区间匹配敏感度。';
  if(name==='陀螺稳定')return'陀螺稳定：最近 gyroZ 波动偏大，建议下调陀螺稳定敏感度。';
  if(name==='大弯稳定')return'大弯稳定：最近大弯区输出不够稳定，建议先检查大弯稳定敏感度，再检查大弯阈值。';
  if(name==='速度稳定')return'速度稳定：最近 pseudoSpeed 波动偏大，建议下调速度稳定敏感度。';
  if(name==='油门稳定')return'油门稳定：最近油门波动偏大，建议下调油门稳定敏感度。';
  return'拖分分析中，继续保持当前动作。';
}
function refreshScoreBreakdown(){
  ...
  if(!scoreState.running||scoreState.samples<SCORE_TREND_WINDOW){
    ...
    scoreState.weakestTrendReason='拖分分析中，继续保持当前动作。';
    return;
  }
  let weakestIndex=-1;
  let weakestDelta=0;
...
function renderScore(){
  ...
  weakestTrendReasonEl.textContent='拖分原因：'+scoreState.weakestTrendReason;
  for(let i=1;i<=6;i++){
...
<style>
body{font-family:system-ui,sans-serif;margin:12px;background:#101318;color:#e8edf2}h1{margin:0;font-size:22px}.headerRow{display:flex;align-items:flex-end;gap:12px;flex-wrap:wrap;margin:0 0 10px}.version{color:#8fa1b5;font-size:12px;text-transform:uppercase;letter-spacing:.08em}.panel{background:#171c24;border:1px solid #2b3441;border-radius:8px;padding:10px;margin-bottom:10px}.panelHead{display:flex;justify-content:space-between;align-items:flex-start;gap:12px;flex-wrap:wrap;margin-bottom:8px}.label{font-size:12px;color:#8fa1b5;text-transform:uppercase;letter-spacing:.08em}.muted{color:#8fa1b5;font-size:12px}.summaryGrid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:12px}.summaryItem{background:#111820;border:1px solid #2b3441;border-radius:10px;padding:10px 12px}.summaryItem .k{font-size:11px;color:#8fa1b5}.summaryItem .v{font-size:18px;font-weight:700;margin-top:4px}.tuneSection{margin-top:16px}.tuneSection .sectionTitle{font-size:13px;font-weight:700;color:#d6deea}.tuneSection .sectionDesc{font-size:11px;color:#8fa1b5;margin-top:2px}.tuneGrid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:12px}.field{display:flex;flex-direction:column;gap:6px;font-size:12px;color:#8fa1b5;background:#111820;border:1px solid #2b3441;border-radius:10px;padding:10px 12px}.fieldTitle{font-size:12px;color:#d6deea;font-weight:700}.fieldHint{font-size:11px;color:#8fa1b5;line-height:1.35;min-height:28px}.field input{background:#0f1720;border:1px solid #2b3441;border-radius:10px;color:#e8edf2;padding:10px 12px;font:inherit}.tuneActions{display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin-top:12px}button{background:#5cc8ff;color:#061019;border:1px solid #5cc8ff;border-radius:999px;padding:8px 18px;font-weight:700;cursor:pointer;font-size:12px}button.alt{background:transparent;color:#5cc8ff;border-color:#5cc8ff}button:disabled{opacity:.5;cursor:not-allowed}#driftConfigStatus{font-size:12px}a{color:#5cc8ff;text-decoration:none}@media(max-width:860px){.tuneGrid{grid-template-columns:repeat(2,1fr)}.summaryGrid{grid-template-columns:repeat(2,1fr)}}@media(max-width:560px){.tuneGrid{grid-template-columns:1fr}.summaryGrid{grid-template-columns:1fr}}
</style>
</head>
<body>
<div class="headerRow"><h1>Drift Assist Tuning</h1><span class="version">GYRO STEERING / THROTTLE</span><a href="/">Back to Drifter Console</a></div>
<div class="panel">
<div class="panelHead"><div><div class="label">Status</div><div class="muted">Live drift state from device</div></div><div id="driftStateCurrent" class="muted">waiting...</div></div>
<div class="summaryGrid">
<div class="summaryItem"><div class="k">Enabled</div><div class="v" id="stateEnabled">--</div></div>
<div class="summaryItem"><div class="k">Active</div><div class="v" id="stateActive">--</div></div>
<div class="summaryItem"><div class="k">Yaw Error</div><div class="v" id="stateYawError">--</div></div>
<div class="summaryItem"><div class="k">Throttle Mode</div><div class="v" id="stateThrottleMode">--</div></div>
</div>
</div>
<div class="panel">
<div class="panelHead"><div><div class="label">Steering Correction</div><div class="muted">Map steering to target yaw rate and apply P+D feedback.</div></div><div id="driftConfigCurrent" class="muted">reading device config...</div></div>
<div class="tuneGrid">
<label class="field"><span class="fieldTitle">Steering Gyro Sign</span><span class="fieldHint">-1 or 1: flips the steering↔gyro mapping direction.</span><input id="steeringGyroSignInput" type="number" step="1"></label>
<label class="field"><span class="fieldTitle">Max Yaw Rate</span><span class="fieldHint">Expected peak yaw rate at full steering (rad/s).</span><input id="maxYawRateInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">Kp</span><span class="fieldHint">Proportional gain on yaw error.</span><input id="kpInput" type="number" step="0.001"></label>
<label class="field"><span class="fieldTitle">Kd</span><span class="fieldHint">Damping gain on current yaw rate.</span><input id="kdInput" type="number" step="0.001"></label>
<label class="field"><span class="fieldTitle">Max Steering Correction</span><span class="fieldHint">0~1: caps the normalized steering offset.</span><input id="maxSteeringCorrectionInput" type="number" step="0.01"></label>
<label class="field"><span class="fieldTitle">Gyro Filter Alpha</span><span class="fieldHint">0~1: higher = more responsive, more noise.</span><input id="gyroFilterAlphaInput" type="number" step="0.01"></label>
</div>
<div class="tuneSection"><div class="sectionTitle">Throttle Strategy</div><div class="sectionDesc">Switch between continuous spin throttle and pulsed drift throttle.</div>
<div class="tuneGrid">
<label class="field"><span class="fieldTitle">Spin Threshold</span><span class="fieldHint">|gyroZ| above this uses continuous throttle.</span><input id="spinThresholdInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">Steering Threshold</span><span class="fieldHint">Min normalized steering before throttle strategy engages.</span><input id="steeringThresholdInput" type="number" step="0.01"></label>
<label class="field"><span class="fieldTitle">Continuous Throttle</span><span class="fieldHint">0~1: throttle used during high yaw-rate spin.</span><input id="continuousThrottleInput" type="number" step="0.01"></label>
<label class="field"><span class="fieldTitle">Pulse Throttle</span><span class="fieldHint">0~1: peak throttle during pulse-on phase.</span><input id="pulseThrottleInput" type="number" step="0.01"></label>
<label class="field"><span class="fieldTitle">Pulse Freq (Hz)</span><span class="fieldHint">Pulses per second in drift throttle mode.</span><input id="pulseFreqHzInput" type="number" step="0.1"></label>
<label class="field"><span class="fieldTitle">Pulse Duty</span><span class="fieldHint">0~1: on-time fraction of each pulse.</span><input id="pulseDutyInput" type="number" step="0.01"></label>
</div>
</div>
<div class="tuneActions"><button id="saveDriftConfigBtn" onclick="saveDriftConfig()">Save Drift Config</button><button id="resetDriftConfigBtn" class="alt" onclick="resetDriftConfigToDefault()">Restore Defaults</button><div id="driftConfigStatus" class="muted">Save to persist in device NVS.</div></div>
</div>
<script>
...
let lastSeq=0;
function setDriftConfigStatus(text,kind){driftConfigStatusEl.textContent=text;driftConfigStatusEl.style.color=kind==='ok'?'#39d98a':kind==='err'?'#ff7b7b':'#8fa1b5'}
...
async function loadDriftConfig(){try{const r=await fetch('/api/drift-config',{cache:'no-store'});if(!r.ok)throw new Error('load_failed');applyDriftConfigPayload(await r.json());driftConfigCurrentEl.textContent='Current device config';setDriftConfigStatus('Synced device config','ok')}catch(e){syncDriftConfigInputs();driftConfigCurrentEl.textContent='Using page defaults';setDriftConfigStatus('Failed to read config, using defaults','err')}}
async function saveDriftConfig(){const config=readDriftConfigForm();if(!driftConfigFormValid(config)){setDriftConfigStatus('Input out of allowed range','err');return}const body=new URLSearchParams({steeringGyroSign:String(config.steeringGyroSign),maxYawRate:config.maxYawRate.toFixed(2),kp:config.kp.toFixed(3),kd:config.kd.toFixed(3),maxSteeringCorrection:config.maxSteeringCorrection.toFixed(2),gyroFilterAlpha:config.gyroFilterAlpha.toFixed(2),spinThreshold:config.spinThreshold.toFixed(2),steeringThreshold:config.steeringThreshold.toFixed(2),continuousThrottle:config.continuousThrottle.toFixed(2),pulseThrottle:config.pulseThrottle.toFixed(2),pulseFreqHz:config.pulseFreqHz.toFixed(2),pulseDuty:config.pulseDuty.toFixed(2)});try{setDriftConfigBusy(true);const r=await fetch('/api/drift-config',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded;charset=UTF-8'},body:body.toString()});const text=await r.text();let payload={};try{payload=JSON.parse(text)}catch(e){}if(!r.ok)throw new Error(payload.error||'save_failed');applyDriftConfigPayload(payload);setDriftConfigStatus('Saved to device NVS','ok')}catch(e){setDriftConfigStatus('Save failed: '+(e.message||'save_failed'),'err')}finally{setDriftConfigBusy(false)}}
async function resetDriftConfigToDefault(){try{setDriftConfigBusy(true);const r=await fetch('/api/drift-config/reset',{method:'POST'});const text=await r.text();let payload={};try{payload=JSON.parse(text)}catch(e){}if(!r.ok)throw new Error(payload.error||'reset_failed');applyDriftConfigPayload(payload);setDriftConfigStatus('Restored defaults and saved to device','ok')}catch(e){setDriftConfigStatus('Reset failed: '+(e.message||'reset_failed'),'err')}finally{setDriftConfigBusy(false)}}
function renderDriftState(latest){if(!latest)return;lastSeq=Math.max(lastSeq,Number(latest.seq||0));stateEnabledEl.textContent=latest.de?'ON':'OFF';stateActiveEl.textContent=latest.da?'ACTIVE':'ARMED';stateYawErrorEl.textContent=Number(latest.dye||0).toFixed(2);const m=Number(latest.dtm||0);stateThrottleModeEl.textContent=m===2?'spin':m===1?'pulse':'pass';driftStateCurrentEl.textContent='seq '+latest.seq;}
async function pollDriftData(){try{const r=await fetch('/api/data?since='+lastSeq,{cache:'no-store'});const j=await r.json();if(j&&j.latest)renderDriftState(j.latest)}catch(e){driftStateCurrentEl.textContent='offline'}}
loadDriftConfig();setInterval(pollDriftData,250);
</script>
</body>
</html>
)rawliteral";
