...
def test_firmware_version_is_current_and_changelog_is_ordered():
    ...
    assert '#define MUS4_FIRMWARE_VERSION "v1.7.85"' in build_info
    ...
    assert changelog.index("v1.7.85") < changelog.index("v1.7.84")
    assert changelog.index("v1.7.84") < changelog.index("v1.7.83")
    assert changelog.index("v1.7.83") < changelog.index("v1.7.82")
