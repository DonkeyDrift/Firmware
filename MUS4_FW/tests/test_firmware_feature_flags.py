...
def test_firmware_version_is_current_and_changelog_is_ordered():
    ...
    assert '#define MUS4_FIRMWARE_VERSION "v1.8.21"' in build_info
    assert "v1.8.21" in changelog
    ...
    assert changelog.index("## 2026-08-20 v1.8.21") < changelog.index("## 2026-08-19 v1.8.20")
