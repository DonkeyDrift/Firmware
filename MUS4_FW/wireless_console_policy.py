...
PARK_LOCKED_COMMANDS = {"TEST", "TEST_TUI", "BENCH", "STRESS", "REGRESS", "FILTER_TEST", "STEER_CAL", "CAL_SAVE", "CAL_RETRY", "CAL_ABORT", "CAL_RESET", "CAL_STATUS", "JOYSTICK_CAL", "JOYSTICK_SAVE", "JOYSTICK_RETRY", "JOYSTICK_ABORT", "JOYSTICK_RESET"}
GENERAL_AUTHENTICATED_COMMANDS = {"ANSI", "NOANSI", "FILTER_DEBUG", "LOG_WEB", "LOG_SERIAL", "SERVO_MID", "MOTOR_MID", "THROTTLE_MIN", "THROTTLE_MAX", "JOYSTICK_STATUS"}
WIFI_STA_CONFIG_COMMANDS = {"WIFI_STA_SSID", "WIFI_STA_PASSWORD", "WIFI_STA_APPLY", "WIFI_STA_CLEAR"}
CALIBRATION_COMMANDS = {"STEER_CAL", "CAL_SAVE", "CAL_RETRY", "CAL_ABORT", "CAL_RESET", "CAL_STATUS", "JOYSTICK_CAL", "JOYSTICK_SAVE", "JOYSTICK_RETRY", "JOYSTICK_ABORT", "JOYSTICK_RESET"}
