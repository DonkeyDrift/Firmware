...
<div id="networkCard" class="stateCard"><div class="stateHead">Network</div><div class="stateSub" id="apIpValue">AP --</div><div class="stateSub" id="staIpValue">STA --</div><div class="stateValue" id="apClientValue" style="position:absolute;right:12px;bottom:10px;font-size:22px">0</div><span class="stateDot"></span></div>
</div>
...
function updateNetworkCard(s){const ap=s.ap_ip||'--',sta=s.sta_ip||'0.0.0.0',clients=s.ap_clients||'0',configured=s.sta_configured==='1',connected=s.sta_connected==='1';apIpValue.textContent='AP '+ap;staIpValue.textContent=configured?'STA '+sta:'STA disabled';apClientValue.textContent=clients;apClientValue.title='AP clients';networkCard.className='stateCard '+(connected?'mode0':configured?'mode1':'driftOff')}
